...
// vs 5.11.2 icon package is licensed under OFL-1.1 https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&amp;id=OFL, {TableCheck https://github.com/kkvesper/vesper-icons}
// 
...
static Widget getIcon(String name,{double? width,double? height,Color? color}) {
    return Vs.names[name]!(width:width,height:height,color:color);
}


static Widget i0Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("0-square")) {
        body = Vs.iconList["0-square"]!;
    }
...
static Widget i1Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("1-square")) {
        body = Vs.iconList["1-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget i2Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("2-square")) {
        body = Vs.iconList["2-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget i3Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("3-square")) {
        body = Vs.iconList["3-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget i4Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("4-square")) {
        body = Vs.iconList["4-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget i5Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("5-square")) {
        body = Vs.iconList["5-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget i6Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("6-square")) {
        body = Vs.iconList["6-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget i7Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("7-square")) {
        body = Vs.iconList["7-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget i8Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("8-square")) {
        body = Vs.iconList["8-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget i9Square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("9-square")) {
        body = Vs.iconList["9-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget aSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("a-square")) {
        body = Vs.iconList["a-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("b-square")) {
        body = Vs.iconList["b-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget baby({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1184 1728" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("baby")) {
        body = Vs.iconList["baby"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bcCard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2368 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("bc-card")) {
        body = Vs.iconList["bc-card"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget butterfly({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("butterfly")) {
        body = Vs.iconList["butterfly"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("c-square")) {
        body = Vs.iconList["c-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget calendar({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("calendar")) {
        body = Vs.iconList["calendar"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget calendarAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("calendar-alt")) {
        body = Vs.iconList["calendar-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget calendarAlt2({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("calendar-alt-2")) {
        body = Vs.iconList["calendar-alt-2"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget camel({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2016 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("camel")) {
        body = Vs.iconList["camel"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget catFace({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("cat-face")) {
        body = Vs.iconList["cat-face"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccCard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2368 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("cc-card")) {
        body = Vs.iconList["cc-card"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget chair({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("chair")) {
        body = Vs.iconList["chair"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget chairAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("chair-alt")) {
        body = Vs.iconList["chair-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget chicken({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("chicken")) {
        body = Vs.iconList["chicken"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget clipNote({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("clip-note")) {
        body = Vs.iconList["clip-note"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget clipNoteO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("clip-note-o")) {
        body = Vs.iconList["clip-note-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget clipboard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("clipboard")) {
        body = Vs.iconList["clipboard"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget clock({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("clock")) {
        body = Vs.iconList["clock"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget clockAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("clock-alt")) {
        body = Vs.iconList["clock-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget comment({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("comment")) {
        body = Vs.iconList["comment"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget commentBubble({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("comment-bubble")) {
        body = Vs.iconList["comment-bubble"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget comments({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1600" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("comments")) {
        body = Vs.iconList["comments"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cow({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2176 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("cow")) {
        body = Vs.iconList["cow"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget crown({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("crown")) {
        body = Vs.iconList["crown"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cutlery({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("cutlery")) {
        body = Vs.iconList["cutlery"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("d-square")) {
        body = Vs.iconList["d-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget doorClosed({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1216 1632" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("door-closed")) {
        body = Vs.iconList["door-closed"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget doorOpen({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1216 2016" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("door-open")) {
        body = Vs.iconList["door-open"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget drumstick({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("drumstick")) {
        body = Vs.iconList["drumstick"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget eSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("e-square")) {
        body = Vs.iconList["e-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget editPage({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("edit-page")) {
        body = Vs.iconList["edit-page"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("f-square")) {
        body = Vs.iconList["f-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget faceAllergy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("face-allergy")) {
        body = Vs.iconList["face-allergy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget faceDislike({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("face-dislike")) {
        body = Vs.iconList["face-dislike"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget faceLike({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("face-like")) {
        body = Vs.iconList["face-like"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileDownload({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("file-download")) {
        body = Vs.iconList["file-download"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileDownloadO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("file-download-o")) {
        body = Vs.iconList["file-download-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileMoveO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1856 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("file-move-o")) {
        body = Vs.iconList["file-move-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget fish({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("fish")) {
        body = Vs.iconList["fish"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget floors({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("floors")) {
        body = Vs.iconList["floors"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget flower({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("flower")) {
        body = Vs.iconList["flower"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("g-square")) {
        body = Vs.iconList["g-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gantt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("gantt")) {
        body = Vs.iconList["gantt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ganttO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1600" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("gantt-o")) {
        body = Vs.iconList["gantt-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget globe({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("globe")) {
        body = Vs.iconList["globe"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget grapes({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1568 1824" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("grapes")) {
        body = Vs.iconList["grapes"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget hSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("h-square")) {
        body = Vs.iconList["h-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget highchair({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("highchair")) {
        body = Vs.iconList["highchair"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget hourglass({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("hourglass")) {
        body = Vs.iconList["hourglass"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget iSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("i-square")) {
        body = Vs.iconList["i-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget idBadgeAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2368 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("id-badge-alt")) {
        body = Vs.iconList["id-badge-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget idCard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2112 1568" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("id-card")) {
        body = Vs.iconList["id-card"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget idCardAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2368 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("id-card-alt")) {
        body = Vs.iconList["id-card-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget jSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("j-square")) {
        body = Vs.iconList["j-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("k-square")) {
        body = Vs.iconList["k-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kakao({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("kakao")) {
        body = Vs.iconList["kakao"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kakaoSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("kakao-square")) {
        body = Vs.iconList["kakao-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kakaotalk({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("kakaotalk")) {
        body = Vs.iconList["kakaotalk"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kakaotalkSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("kakaotalk-square")) {
        body = Vs.iconList["kakaotalk-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kanjiChu({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("kanji-chu")) {
        body = Vs.iconList["kanji-chu"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kanjiUtage({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("kanji-utage")) {
        body = Vs.iconList["kanji-utage"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kanjiYubi({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1824 1824" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("kanji-yubi")) {
        body = Vs.iconList["kanji-yubi"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget keyboard({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("keyboard")) {
        body = Vs.iconList["keyboard"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget lSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("l-square")) {
        body = Vs.iconList["l-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget language({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("language")) {
        body = Vs.iconList["language"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget line({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1728" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("line")) {
        body = Vs.iconList["line"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget lineSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("line-square")) {
        body = Vs.iconList["line-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("m-square")) {
        body = Vs.iconList["m-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget magnetNote({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("magnet-note")) {
        body = Vs.iconList["magnet-note"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget maleFemale({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2656 2080" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("male-female")) {
        body = Vs.iconList["male-female"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mic({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("mic")) {
        body = Vs.iconList["mic"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mobile({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("mobile")) {
        body = Vs.iconList["mobile"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget moon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("moon")) {
        body = Vs.iconList["moon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget multiArrow({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2208 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("multi-arrow")) {
        body = Vs.iconList["multi-arrow"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget nSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("n-square")) {
        body = Vs.iconList["n-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget naver({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1632" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("naver")) {
        body = Vs.iconList["naver"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget naverSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("naver-square")) {
        body = Vs.iconList["naver-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget neko({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("neko")) {
        body = Vs.iconList["neko"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget nekoSleep({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("neko-sleep")) {
        body = Vs.iconList["neko-sleep"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ninja({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("ninja")) {
        body = Vs.iconList["ninja"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget noCommentBubble({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("no-comment-bubble")) {
        body = Vs.iconList["no-comment-bubble"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget noSmokingAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("no-smoking-alt")) {
        body = Vs.iconList["no-smoking-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget oSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("o-square")) {
        body = Vs.iconList["o-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget p({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("p")) {
        body = Vs.iconList["p"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("p-square")) {
        body = Vs.iconList["p-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget panther({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2016 1984" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("panther")) {
        body = Vs.iconList["panther"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget party({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2112 1920" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("party")) {
        body = Vs.iconList["party"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget peopleGroup({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2624 2016" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("people-group")) {
        body = Vs.iconList["people-group"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget person({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("person")) {
        body = Vs.iconList["person"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pig({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("pig")) {
        body = Vs.iconList["pig"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pregnant({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1184 2048" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("pregnant")) {
        body = Vs.iconList["pregnant"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget profile({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("profile")) {
        body = Vs.iconList["profile"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget qSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("q-square")) {
        body = Vs.iconList["q-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget questionSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("question-square")) {
        body = Vs.iconList["question-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("r-square")) {
        body = Vs.iconList["r-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rose({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("rose")) {
        body = Vs.iconList["rose"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("s-square")) {
        body = Vs.iconList["s-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget senior({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("senior")) {
        body = Vs.iconList["senior"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sexFemale({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("sex-female")) {
        body = Vs.iconList["sex-female"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sexMale({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("sex-male")) {
        body = Vs.iconList["sex-male"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sheep({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2016 2048" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("sheep")) {
        body = Vs.iconList["sheep"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget shieldCheck({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2016 2176" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("shield-check")) {
        body = Vs.iconList["shield-check"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget shieldTimes({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2016 2176" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("shield-times")) {
        body = Vs.iconList["shield-times"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shop({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("shop")) {
        body = Vs.iconList["shop"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sleep({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("sleep")) {
        body = Vs.iconList["sleep"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sleepSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("sleep-square")) {
        body = Vs.iconList["sleep-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget smoking({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("smoking")) {
        body = Vs.iconList["smoking"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget smokingAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1344" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("smoking-alt")) {
        body = Vs.iconList["smoking-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sms({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1600" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("sms")) {
        body = Vs.iconList["sms"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sofa({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("sofa")) {
        body = Vs.iconList["sofa"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget speech({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("speech")) {
        body = Vs.iconList["speech"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget spinner({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1536 1344" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("spinner")) {
        body = Vs.iconList["spinner"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stickyNote({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1600" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("sticky-note")) {
        body = Vs.iconList["sticky-note"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stroller({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1536" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("stroller")) {
        body = Vs.iconList["stroller"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sun({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("sun")) {
        body = Vs.iconList["sun"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sunrise({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("sunrise")) {
        body = Vs.iconList["sunrise"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sunriseO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("sunrise-o")) {
        body = Vs.iconList["sunrise-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("t-square")) {
        body = Vs.iconList["t-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget table({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("table")) {
        body = Vs.iconList["table"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tableAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("table-alt")) {
        body = Vs.iconList["table-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tableO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("table-o")) {
        body = Vs.iconList["table-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tableQuestion({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2560 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("table-question")) {
        body = Vs.iconList["table-question"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tables({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("tables")) {
        body = Vs.iconList["tables"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tablesolution({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("tablesolution")) {
        body = Vs.iconList["tablesolution"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget timeslot({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1344" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("timeslot")) {
        body = Vs.iconList["timeslot"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget timeslotQuestion({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2560 1344" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("timeslot-question")) {
        body = Vs.iconList["timeslot-question"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget timeslots({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2080 1504" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("timeslots")) {
        body = Vs.iconList["timeslots"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget uSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("u-square")) {
        body = Vs.iconList["u-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userBoss({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("user-boss")) {
        body = Vs.iconList["user-boss"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget userGroup({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("user-group")) {
        body = Vs.iconList["user-group"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userSuit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("user-suit")) {
        body = Vs.iconList["user-suit"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userSuitFemale({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("user-suit-female")) {
        body = Vs.iconList["user-suit-female"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userWaiter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("user-waiter")) {
        body = Vs.iconList["user-waiter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userWaiterFemale({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("user-waiter-female")) {
        body = Vs.iconList["user-waiter-female"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget vSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("v-square")) {
        body = Vs.iconList["v-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget volumeOn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2016 1728" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("volume-on")) {
        body = Vs.iconList["volume-on"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget volumeTimes({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1824 1472" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("volume-times")) {
        body = Vs.iconList["volume-times"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("w-square")) {
        body = Vs.iconList["w-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget walk({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Vs.iconList.containsKey("walk")) {
        body = Vs.iconList["walk"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget weddingCake({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1920" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("wedding-cake")) {
        body = Vs.iconList["wedding-cake"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget whiteboard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("whiteboard")) {
        body = Vs.iconList["whiteboard"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget window({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("window")) {
        body = Vs.iconList["window"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wine({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 2016" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("wine")) {
        body = Vs.iconList["wine"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wineO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1120 2208" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("wine-o")) {
        body = Vs.iconList["wine-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget xSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("x-square")) {
        body = Vs.iconList["x-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ySquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("y-square")) {
        body = Vs.iconList["y-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget yahooJapan({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2208 1440" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("yahoo-japan")) {
        body = Vs.iconList["yahoo-japan"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget zSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Vs.iconList.containsKey("z-square")) {
        body = Vs.iconList["z-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Map<String,Widget Function({double? width,double? height,Color? color})> names  =   {
    ...
    "edit-page":editPage,
    "f-square":fSquare,
    "face-allergy":faceAllergy,
    "face-dislike":faceDislike,
    "face-like":faceLike,
    "file-download":fileDownload,
    "file-download-o":fileDownloadO,
    "file-move-o":fileMoveO,
    "fish":fish,
    "floors":floors,
    "flower":flower,
    "g-square":gSquare,
    ...
    "hourglass":hourglass,
    "i-square":iSquare,
    "id-badge-alt":idBadgeAlt,
    "id-card":idCard,
    "id-card-alt":idCardAlt,
    "j-square":jSquare,
    "k-square":kSquare,
    "kakao":kakao,
    "kakao-square":kakaoSquare,
    "kakaotalk":kakaotalk,
    "kakaotalk-square":kakaotalkSquare,
    "kanji-chu":kanjiChu,
    "kanji-utage":kanjiUtage,
    "kanji-yubi":kanjiYubi,
    "keyboard":keyboard,
    "l-square":lSquare,
    "language":language,
    "line":line,
    "line-square":lineSquare,
    "m-square":mSquare,
    "magnet-note":magnetNote,
    ...
    "n-square":nSquare,
    "naver":naver,
    "naver-square":naverSquare,
    "neko":neko,
    "neko-sleep":nekoSleep,
    "ninja":ninja,
    "no-comment-bubble":noCommentBubble,
    "no-smoking-alt":noSmokingAlt,
    "o-square":oSquare,
    "p":p,
    "p-square":pSquare,
    "panther":panther,
    ...
    "shield-times":shieldTimes,
    "shop":shop,
    "sleep":sleep,
    "sleep-square":sleepSquare,
    "smoking":smoking,
    "smoking-alt":smokingAlt,
    "sms":sms,
    "sofa":sofa,
    "speech":speech,
    "spinner":spinner,
    ...
    "timeslot":timeslot,
    "timeslot-question":timeslotQuestion,
    "timeslots":timeslots,
    "u-square":uSquare,
    "user-boss":userBoss,
    "user-group":userGroup,
    "user-suit":userSuit,
    "user-suit-female":userSuitFemale,
    "user-waiter":userWaiter,
    "user-waiter-female":userWaiterFemale,
    "v-square":vSquare,
    "volume-on":volumeOn,
    "volume-times":volumeTimes,
    "w-square":wSquare,
    "walk":walk,
