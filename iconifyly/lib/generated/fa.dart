...
// fa 4.7.0 icon package is licensed under OFL-1.1 https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&amp;id=OFL, {Dave Gandy https://github.com/FortAwesome/Font-Awesome/tree/fa-4}
// 
...
static Widget getIcon(String name,{double? width,double? height,Color? color}) {
    return Fa.names[name]!(width:width,height:height,color:color);
}


static Widget i500Px({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("500px")) {
        body = Fa.iconList["500px"]!;
    }
...
static Widget addressBook({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("address-book")) {
        body = Fa.iconList["address-book"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget addressBookO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("address-book-o")) {
        body = Fa.iconList["address-book-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget addressCard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("address-card")) {
        body = Fa.iconList["address-card"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget addressCardO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("address-card-o")) {
        body = Fa.iconList["address-card-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget adjust({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("adjust")) {
        body = Fa.iconList["adjust"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget adn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("adn")) {
        body = Fa.iconList["adn"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget alignCenter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("align-center")) {
        body = Fa.iconList["align-center"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget alignJustify({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("align-justify")) {
        body = Fa.iconList["align-justify"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget alignLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("align-left")) {
        body = Fa.iconList["align-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget amazon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("amazon")) {
        body = Fa.iconList["amazon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ambulance({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1856 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ambulance")) {
        body = Fa.iconList["ambulance"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget americanSignLanguageInterpreting({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("american-sign-language-interpreting")) {
        body = Fa.iconList["american-sign-language-interpreting"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget anchor({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("anchor")) {
        body = Fa.iconList["anchor"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget android({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("android")) {
        body = Fa.iconList["android"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget angellist({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("angellist")) {
        body = Fa.iconList["angellist"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget angleDoubleLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 992 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("angle-double-left")) {
        body = Fa.iconList["angle-double-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget angleDoubleUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("angle-double-up")) {
        body = Fa.iconList["angle-double-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget angleDown({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("angle-down")) {
        body = Fa.iconList["angle-down"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget angleLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 608 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("angle-left")) {
        body = Fa.iconList["angle-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget angleUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("angle-up")) {
        body = Fa.iconList["angle-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget apple({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("apple")) {
        body = Fa.iconList["apple"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget archive({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("archive")) {
        body = Fa.iconList["archive"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget areaChart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("area-chart")) {
        body = Fa.iconList["area-chart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget arrowCircleLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrow-circle-left")) {
        body = Fa.iconList["arrow-circle-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget arrowCircleOLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrow-circle-o-left")) {
        body = Fa.iconList["arrow-circle-o-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget arrowCircleOUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrow-circle-o-up")) {
        body = Fa.iconList["arrow-circle-o-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget arrowCircleUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrow-circle-up")) {
        body = Fa.iconList["arrow-circle-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget arrowLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrow-left")) {
        body = Fa.iconList["arrow-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget arrowUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1600 1472" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrow-up")) {
        body = Fa.iconList["arrow-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget arrows({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrows")) {
        body = Fa.iconList["arrows"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget arrowsAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrows-alt")) {
        body = Fa.iconList["arrows-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget arrowsH({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrows-h")) {
        body = Fa.iconList["arrows-h"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget arrowsV({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("arrows-v")) {
        body = Fa.iconList["arrows-v"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget assistiveListeningSystems({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("assistive-listening-systems")) {
        body = Fa.iconList["assistive-listening-systems"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget asterisk({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("asterisk")) {
        body = Fa.iconList["asterisk"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget audioDescription({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("audio-description")) {
        body = Fa.iconList["audio-description"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget automobile({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("automobile")) {
        body = Fa.iconList["automobile"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget backward({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1568 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("backward")) {
        body = Fa.iconList["backward"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget balanceScale({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2176 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("balance-scale")) {
        body = Fa.iconList["balance-scale"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ban({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1568" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ban")) {
        body = Fa.iconList["ban"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bandcamp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bandcamp")) {
        body = Fa.iconList["bandcamp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bank({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bank")) {
        body = Fa.iconList["bank"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget barChart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bar-chart")) {
        body = Fa.iconList["bar-chart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget barcode({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("barcode")) {
        body = Fa.iconList["barcode"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bars({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bars")) {
        body = Fa.iconList["bars"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bath({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bath")) {
        body = Fa.iconList["bath"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget battery({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("battery")) {
        body = Fa.iconList["battery"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget battery0({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("battery-0")) {
        body = Fa.iconList["battery-0"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget battery1({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("battery-1")) {
        body = Fa.iconList["battery-1"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget battery2({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("battery-2")) {
        body = Fa.iconList["battery-2"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget battery3({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("battery-3")) {
        body = Fa.iconList["battery-3"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bed({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bed")) {
        body = Fa.iconList["bed"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget beer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1600 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("beer")) {
        body = Fa.iconList["beer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget behance({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1344" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("behance")) {
        body = Fa.iconList["behance"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget behanceSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("behance-square")) {
        body = Fa.iconList["behance-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bell({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bell")) {
        body = Fa.iconList["bell"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bellO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bell-o")) {
        body = Fa.iconList["bell-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bellSlash({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bell-slash")) {
        body = Fa.iconList["bell-slash"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bellSlashO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bell-slash-o")) {
        body = Fa.iconList["bell-slash-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bicycle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bicycle")) {
        body = Fa.iconList["bicycle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget binoculars({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("binoculars")) {
        body = Fa.iconList["binoculars"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget birthdayCake({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("birthday-cake")) {
        body = Fa.iconList["birthday-cake"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bitbucket({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1440 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bitbucket")) {
        body = Fa.iconList["bitbucket"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bitbucketSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bitbucket-square")) {
        body = Fa.iconList["bitbucket-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bitcoin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1248 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bitcoin")) {
        body = Fa.iconList["bitcoin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget blackTie({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("black-tie")) {
        body = Fa.iconList["black-tie"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget blind({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1344 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("blind")) {
        body = Fa.iconList["blind"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bluetooth({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1344 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bluetooth")) {
        body = Fa.iconList["bluetooth"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bluetoothB({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 960 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bluetooth-b")) {
        body = Fa.iconList["bluetooth-b"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bold({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bold")) {
        body = Fa.iconList["bold"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bolt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 896 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bolt")) {
        body = Fa.iconList["bolt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bomb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bomb")) {
        body = Fa.iconList["bomb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget book({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1696 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("book")) {
        body = Fa.iconList["book"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bookmark({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bookmark")) {
        body = Fa.iconList["bookmark"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bookmarkO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bookmark-o")) {
        body = Fa.iconList["bookmark-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget braille({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2176 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("braille")) {
        body = Fa.iconList["braille"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget briefcase({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("briefcase")) {
        body = Fa.iconList["briefcase"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bug({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1600 1568" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bug")) {
        body = Fa.iconList["bug"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget building({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("building")) {
        body = Fa.iconList["building"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget buildingO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("building-o")) {
        body = Fa.iconList["building-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bullhorn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bullhorn")) {
        body = Fa.iconList["bullhorn"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bullseye({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bullseye")) {
        body = Fa.iconList["bullseye"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("bus")) {
        body = Fa.iconList["bus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget buysellads({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("buysellads")) {
        body = Fa.iconList["buysellads"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cab({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cab")) {
        body = Fa.iconList["cab"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget calculator({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("calculator")) {
        body = Fa.iconList["calculator"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget calendar({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("calendar")) {
        body = Fa.iconList["calendar"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget calendarCheckO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("calendar-check-o")) {
        body = Fa.iconList["calendar-check-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget calendarMinusO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("calendar-minus-o")) {
        body = Fa.iconList["calendar-minus-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget calendarO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("calendar-o")) {
        body = Fa.iconList["calendar-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget calendarPlusO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("calendar-plus-o")) {
        body = Fa.iconList["calendar-plus-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget calendarTimesO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("calendar-times-o")) {
        body = Fa.iconList["calendar-times-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget camera({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("camera")) {
        body = Fa.iconList["camera"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cameraRetro({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("camera-retro")) {
        body = Fa.iconList["camera-retro"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget caretDown({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("caret-down")) {
        body = Fa.iconList["caret-down"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget caretLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("caret-left")) {
        body = Fa.iconList["caret-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget caretSquareOLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("caret-square-o-left")) {
        body = Fa.iconList["caret-square-o-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget caretSquareOUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("caret-square-o-up")) {
        body = Fa.iconList["caret-square-o-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget caretUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("caret-up")) {
        body = Fa.iconList["caret-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cartArrowDown({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cart-arrow-down")) {
        body = Fa.iconList["cart-arrow-down"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cartPlus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cart-plus")) {
        body = Fa.iconList["cart-plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cc")) {
        body = Fa.iconList["cc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccAmex({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cc-amex")) {
        body = Fa.iconList["cc-amex"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccDinersClub({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cc-diners-club")) {
        body = Fa.iconList["cc-diners-club"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccDiscover({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cc-discover")) {
        body = Fa.iconList["cc-discover"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccJcb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cc-jcb")) {
        body = Fa.iconList["cc-jcb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccMastercard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cc-mastercard")) {
        body = Fa.iconList["cc-mastercard"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccPaypal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cc-paypal")) {
        body = Fa.iconList["cc-paypal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccStripe({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cc-stripe")) {
        body = Fa.iconList["cc-stripe"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccVisa({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cc-visa")) {
        body = Fa.iconList["cc-visa"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget certificate({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("certificate")) {
        body = Fa.iconList["certificate"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget chain({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("chain")) {
        body = Fa.iconList["chain"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget chainBroken({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("chain-broken")) {
        body = Fa.iconList["chain-broken"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget check({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1600 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("check")) {
        body = Fa.iconList["check"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget checkCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("check-circle")) {
        body = Fa.iconList["check-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget checkCircleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("check-circle-o")) {
        body = Fa.iconList["check-circle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget checkSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("check-square")) {
        body = Fa.iconList["check-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget checkSquareO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("check-square-o")) {
        body = Fa.iconList["check-square-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget chevronCircleLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("chevron-circle-left")) {
        body = Fa.iconList["chevron-circle-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget chevronCircleUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("chevron-circle-up")) {
        body = Fa.iconList["chevron-circle-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget chevronDown({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1312" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("chevron-down")) {
        body = Fa.iconList["chevron-down"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget chevronLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1088 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("chevron-left")) {
        body = Fa.iconList["chevron-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget chevronUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("chevron-up")) {
        body = Fa.iconList["chevron-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget child({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1632" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("child")) {
        body = Fa.iconList["child"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget chrome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("chrome")) {
        body = Fa.iconList["chrome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget circle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("circle")) {
        body = Fa.iconList["circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget circleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("circle-o")) {
        body = Fa.iconList["circle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget circleONotch({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1728" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("circle-o-notch")) {
        body = Fa.iconList["circle-o-notch"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget circleThin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("circle-thin")) {
        body = Fa.iconList["circle-thin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget clipboard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("clipboard")) {
        body = Fa.iconList["clipboard"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget clockO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("clock-o")) {
        body = Fa.iconList["clock-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget clone({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("clone")) {
        body = Fa.iconList["clone"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget close({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1216 1312" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("close")) {
        body = Fa.iconList["close"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cloud({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cloud")) {
        body = Fa.iconList["cloud"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cloudDownload({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cloud-download")) {
        body = Fa.iconList["cloud-download"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cloudUpload({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cloud-upload")) {
        body = Fa.iconList["cloud-upload"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cny({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cny")) {
        body = Fa.iconList["cny"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget code({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1856 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("code")) {
        body = Fa.iconList["code"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget codeFork({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("code-fork")) {
        body = Fa.iconList["code-fork"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget codepen({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("codepen")) {
        body = Fa.iconList["codepen"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget codiepie({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("codiepie")) {
        body = Fa.iconList["codiepie"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget coffee({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1856 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("coffee")) {
        body = Fa.iconList["coffee"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cog({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cog")) {
        body = Fa.iconList["cog"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cogs({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cogs")) {
        body = Fa.iconList["cogs"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget columns({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("columns")) {
        body = Fa.iconList["columns"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget comment({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("comment")) {
        body = Fa.iconList["comment"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget commentO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("comment-o")) {
        body = Fa.iconList["comment-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget commenting({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1504" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("commenting")) {
        body = Fa.iconList["commenting"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget commentingO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("commenting-o")) {
        body = Fa.iconList["commenting-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget comments({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("comments")) {
        body = Fa.iconList["comments"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget commentsO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("comments-o")) {
        body = Fa.iconList["comments-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget compass({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("compass")) {
        body = Fa.iconList["compass"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget compress({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("compress")) {
        body = Fa.iconList["compress"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget connectdevelop({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("connectdevelop")) {
        body = Fa.iconList["connectdevelop"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget contao({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("contao")) {
        body = Fa.iconList["contao"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget copy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("copy")) {
        body = Fa.iconList["copy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget copyright({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("copyright")) {
        body = Fa.iconList["copyright"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget creativeCommons({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("creative-commons")) {
        body = Fa.iconList["creative-commons"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creditCard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("credit-card")) {
        body = Fa.iconList["credit-card"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creditCardAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("credit-card-alt")) {
        body = Fa.iconList["credit-card-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget crop({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("crop")) {
        body = Fa.iconList["crop"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget crosshairs({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("crosshairs")) {
        body = Fa.iconList["crosshairs"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget css3({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("css3")) {
        body = Fa.iconList["css3"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cube({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cube")) {
        body = Fa.iconList["cube"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cubes({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2176 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cubes")) {
        body = Fa.iconList["cubes"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cut({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cut")) {
        body = Fa.iconList["cut"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget cutlery({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("cutlery")) {
        body = Fa.iconList["cutlery"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget dashboard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("dashboard")) {
        body = Fa.iconList["dashboard"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dashcube({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("dashcube")) {
        body = Fa.iconList["dashcube"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget database({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("database")) {
        body = Fa.iconList["database"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget deaf({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("deaf")) {
        body = Fa.iconList["deaf"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dedent({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("dedent")) {
        body = Fa.iconList["dedent"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget delicious({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("delicious")) {
        body = Fa.iconList["delicious"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget desktop({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("desktop")) {
        body = Fa.iconList["desktop"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget deviantart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("deviantart")) {
        body = Fa.iconList["deviantart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget diamond({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("diamond")) {
        body = Fa.iconList["diamond"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget digg({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("digg")) {
        body = Fa.iconList["digg"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget dollar({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 960 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("dollar")) {
        body = Fa.iconList["dollar"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dotCircleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("dot-circle-o")) {
        body = Fa.iconList["dot-circle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget download({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("download")) {
        body = Fa.iconList["download"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget dribbble({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("dribbble")) {
        body = Fa.iconList["dribbble"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget driversLicense({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("drivers-license")) {
        body = Fa.iconList["drivers-license"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget driversLicenseO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("drivers-license-o")) {
        body = Fa.iconList["drivers-license-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dropbox({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1568" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("dropbox")) {
        body = Fa.iconList["dropbox"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget drupal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("drupal")) {
        body = Fa.iconList["drupal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget edge({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("edge")) {
        body = Fa.iconList["edge"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget edit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("edit")) {
        body = Fa.iconList["edit"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget eercast({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("eercast")) {
        body = Fa.iconList["eercast"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget eject({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1568 1312" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("eject")) {
        body = Fa.iconList["eject"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ellipsisH({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ellipsis-h")) {
        body = Fa.iconList["ellipsis-h"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ellipsisV({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ellipsis-v")) {
        body = Fa.iconList["ellipsis-v"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget empire({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("empire")) {
        body = Fa.iconList["empire"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget envelope({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("envelope")) {
        body = Fa.iconList["envelope"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget envelopeO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("envelope-o")) {
        body = Fa.iconList["envelope-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget envelopeOpen({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("envelope-open")) {
        body = Fa.iconList["envelope-open"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget envelopeOpenO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("envelope-open-o")) {
        body = Fa.iconList["envelope-open-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget envelopeSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("envelope-square")) {
        body = Fa.iconList["envelope-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget envira({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("envira")) {
        body = Fa.iconList["envira"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget eraser({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("eraser")) {
        body = Fa.iconList["eraser"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget etsy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("etsy")) {
        body = Fa.iconList["etsy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget eur({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("eur")) {
        body = Fa.iconList["eur"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget exchange({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1376" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("exchange")) {
        body = Fa.iconList["exchange"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget exclamation({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 448 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("exclamation")) {
        body = Fa.iconList["exclamation"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget exclamationCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("exclamation-circle")) {
        body = Fa.iconList["exclamation-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget exclamationTriangle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1856 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("exclamation-triangle")) {
        body = Fa.iconList["exclamation-triangle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget expand({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("expand")) {
        body = Fa.iconList["expand"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget expeditedssl({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("expeditedssl")) {
        body = Fa.iconList["expeditedssl"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget externalLink({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("external-link")) {
        body = Fa.iconList["external-link"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget externalLinkSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("external-link-square")) {
        body = Fa.iconList["external-link-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget eye({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("eye")) {
        body = Fa.iconList["eye"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget eyeSlash({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1376" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("eye-slash")) {
        body = Fa.iconList["eye-slash"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget eyedropper({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("eyedropper")) {
        body = Fa.iconList["eyedropper"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fa({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1504 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("fa")) {
        body = Fa.iconList["fa"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget facebook({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 896 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("facebook")) {
        body = Fa.iconList["facebook"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget facebookOfficial({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("facebook-official")) {
        body = Fa.iconList["facebook-official"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget facebookSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("facebook-square")) {
        body = Fa.iconList["facebook-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget fastBackward({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("fast-backward")) {
        body = Fa.iconList["fast-backward"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget fax({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("fax")) {
        body = Fa.iconList["fax"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget feed({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("feed")) {
        body = Fa.iconList["feed"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget female({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 1760" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("female")) {
        body = Fa.iconList["female"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fighterJet({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("fighter-jet")) {
        body = Fa.iconList["fighter-jet"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget file({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file")) {
        body = Fa.iconList["file"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileArchiveO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-archive-o")) {
        body = Fa.iconList["file-archive-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileAudioO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-audio-o")) {
        body = Fa.iconList["file-audio-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileCodeO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-code-o")) {
        body = Fa.iconList["file-code-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileExcelO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-excel-o")) {
        body = Fa.iconList["file-excel-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileImageO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-image-o")) {
        body = Fa.iconList["file-image-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileMovieO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-movie-o")) {
        body = Fa.iconList["file-movie-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-o")) {
        body = Fa.iconList["file-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget filePdfO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-pdf-o")) {
        body = Fa.iconList["file-pdf-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget filePowerpointO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-powerpoint-o")) {
        body = Fa.iconList["file-powerpoint-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget fileText({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-text")) {
        body = Fa.iconList["file-text"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileTextO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-text-o")) {
        body = Fa.iconList["file-text-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fileWordO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("file-word-o")) {
        body = Fa.iconList["file-word-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget film({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("film")) {
        body = Fa.iconList["film"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget filter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("filter")) {
        body = Fa.iconList["filter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget fire({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("fire")) {
        body = Fa.iconList["fire"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fireExtinguisher({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1632" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("fire-extinguisher")) {
        body = Fa.iconList["fire-extinguisher"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget firefox({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1760" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("firefox")) {
        body = Fa.iconList["firefox"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget firstOrder({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("first-order")) {
        body = Fa.iconList["first-order"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget flag({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("flag")) {
        body = Fa.iconList["flag"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget flagCheckered({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("flag-checkered")) {
        body = Fa.iconList["flag-checkered"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget flagO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("flag-o")) {
        body = Fa.iconList["flag-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget flask({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("flask")) {
        body = Fa.iconList["flask"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget flickr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("flickr")) {
        body = Fa.iconList["flickr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget floppyO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("floppy-o")) {
        body = Fa.iconList["floppy-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget folder({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("folder")) {
        body = Fa.iconList["folder"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget folderO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("folder-o")) {
        body = Fa.iconList["folder-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget folderOpen({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1888 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("folder-open")) {
        body = Fa.iconList["folder-open"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget folderOpenO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("folder-open-o")) {
        body = Fa.iconList["folder-open-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget font({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("font")) {
        body = Fa.iconList["font"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fonticons({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("fonticons")) {
        body = Fa.iconList["fonticons"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fortAwesome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("fort-awesome")) {
        body = Fa.iconList["fort-awesome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget forumbee({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("forumbee")) {
        body = Fa.iconList["forumbee"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget foursquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1216 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("foursquare")) {
        body = Fa.iconList["foursquare"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget freeCodeCamp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("free-code-camp")) {
        body = Fa.iconList["free-code-camp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget frownO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("frown-o")) {
        body = Fa.iconList["frown-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget futbolO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("futbol-o")) {
        body = Fa.iconList["futbol-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget gamepad({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("gamepad")) {
        body = Fa.iconList["gamepad"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gavel({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1760 1760" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("gavel")) {
        body = Fa.iconList["gavel"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget gbp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("gbp")) {
        body = Fa.iconList["gbp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget genderless({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("genderless")) {
        body = Fa.iconList["genderless"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget getPocket({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("get-pocket")) {
        body = Fa.iconList["get-pocket"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gg({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1344" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("gg")) {
        body = Fa.iconList["gg"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ggCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("gg-circle")) {
        body = Fa.iconList["gg-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gift({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1344" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("gift")) {
        body = Fa.iconList["gift"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget git({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("git")) {
        body = Fa.iconList["git"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gitSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("git-square")) {
        body = Fa.iconList["git-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget github({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1504" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("github")) {
        body = Fa.iconList["github"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget githubAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("github-alt")) {
        body = Fa.iconList["github-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget githubSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("github-square")) {
        body = Fa.iconList["github-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gitlab({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("gitlab")) {
        body = Fa.iconList["gitlab"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gittip({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("gittip")) {
        body = Fa.iconList["gittip"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget glass({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("glass")) {
        body = Fa.iconList["glass"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget glide({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("glide")) {
        body = Fa.iconList["glide"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget glideG({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("glide-g")) {
        body = Fa.iconList["glide-g"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget globe({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("globe")) {
        body = Fa.iconList["globe"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget google({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("google")) {
        body = Fa.iconList["google"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget googlePlus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1472" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("google-plus")) {
        body = Fa.iconList["google-plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget googlePlusCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("google-plus-circle")) {
        body = Fa.iconList["google-plus-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget googlePlusSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("google-plus-square")) {
        body = Fa.iconList["google-plus-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget googleWallet({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1760 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("google-wallet")) {
        body = Fa.iconList["google-wallet"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget graduationCap({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("graduation-cap")) {
        body = Fa.iconList["graduation-cap"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget grav({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1824 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("grav")) {
        body = Fa.iconList["grav"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget group({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("group")) {
        body = Fa.iconList["group"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("h-square")) {
        body = Fa.iconList["h-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hackerNews({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hacker-news")) {
        body = Fa.iconList["hacker-news"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handGrabO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hand-grab-o")) {
        body = Fa.iconList["hand-grab-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handLizardO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hand-lizard-o")) {
        body = Fa.iconList["hand-lizard-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handOLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hand-o-left")) {
        body = Fa.iconList["hand-o-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handOUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hand-o-up")) {
        body = Fa.iconList["hand-o-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handPaperO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1632 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hand-paper-o")) {
        body = Fa.iconList["hand-paper-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handPeaceO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hand-peace-o")) {
        body = Fa.iconList["hand-peace-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handPointerO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hand-pointer-o")) {
        body = Fa.iconList["hand-pointer-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handScissorsO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hand-scissors-o")) {
        body = Fa.iconList["hand-scissors-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handSpockO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hand-spock-o")) {
        body = Fa.iconList["hand-spock-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget handshakeO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1472" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("handshake-o")) {
        body = Fa.iconList["handshake-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget hashtag({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hashtag")) {
        body = Fa.iconList["hashtag"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hddO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hdd-o")) {
        body = Fa.iconList["hdd-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget header({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("header")) {
        body = Fa.iconList["header"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget headphones({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("headphones")) {
        body = Fa.iconList["headphones"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget heart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("heart")) {
        body = Fa.iconList["heart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget heartO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("heart-o")) {
        body = Fa.iconList["heart-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget heartbeat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("heartbeat")) {
        body = Fa.iconList["heartbeat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget history({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("history")) {
        body = Fa.iconList["history"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget home({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1312" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("home")) {
        body = Fa.iconList["home"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hospitalO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hospital-o")) {
        body = Fa.iconList["hospital-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget hourglass({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hourglass")) {
        body = Fa.iconList["hourglass"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hourglass1({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hourglass-1")) {
        body = Fa.iconList["hourglass-1"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hourglass2({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hourglass-2")) {
        body = Fa.iconList["hourglass-2"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hourglass3({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hourglass-3")) {
        body = Fa.iconList["hourglass-3"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hourglassO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("hourglass-o")) {
        body = Fa.iconList["hourglass-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget houzz({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("houzz")) {
        body = Fa.iconList["houzz"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget html5({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("html5")) {
        body = Fa.iconList["html5"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget iCursor({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 896 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("i-cursor")) {
        body = Fa.iconList["i-cursor"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget idBadge({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("id-badge")) {
        body = Fa.iconList["id-badge"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ils({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1376 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ils")) {
        body = Fa.iconList["ils"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget image({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("image")) {
        body = Fa.iconList["image"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget imdb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("imdb")) {
        body = Fa.iconList["imdb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget inbox({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("inbox")) {
        body = Fa.iconList["inbox"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget indent({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("indent")) {
        body = Fa.iconList["indent"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget industry({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("industry")) {
        body = Fa.iconList["industry"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget info({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("info")) {
        body = Fa.iconList["info"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget infoCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("info-circle")) {
        body = Fa.iconList["info-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget inr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 928 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("inr")) {
        body = Fa.iconList["inr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget instagram({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("instagram")) {
        body = Fa.iconList["instagram"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget internetExplorer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("internet-explorer")) {
        body = Fa.iconList["internet-explorer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget intersex({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("intersex")) {
        body = Fa.iconList["intersex"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ioxhost({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ioxhost")) {
        body = Fa.iconList["ioxhost"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget italic({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("italic")) {
        body = Fa.iconList["italic"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget joomla({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("joomla")) {
        body = Fa.iconList["joomla"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget jsfiddle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("jsfiddle")) {
        body = Fa.iconList["jsfiddle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget key({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1696 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("key")) {
        body = Fa.iconList["key"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget keyboardO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("keyboard-o")) {
        body = Fa.iconList["keyboard-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget krw({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("krw")) {
        body = Fa.iconList["krw"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget language({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("language")) {
        body = Fa.iconList["language"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget laptop({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("laptop")) {
        body = Fa.iconList["laptop"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget lastfm({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("lastfm")) {
        body = Fa.iconList["lastfm"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget lastfmSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("lastfm-square")) {
        body = Fa.iconList["lastfm-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget leaf({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("leaf")) {
        body = Fa.iconList["leaf"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget leanpub({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("leanpub")) {
        body = Fa.iconList["leanpub"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget lemonO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("lemon-o")) {
        body = Fa.iconList["lemon-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget levelUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1056 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("level-up")) {
        body = Fa.iconList["level-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget lifeBouy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("life-bouy")) {
        body = Fa.iconList["life-bouy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget lightbulbO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("lightbulb-o")) {
        body = Fa.iconList["lightbulb-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget lineChart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("line-chart")) {
        body = Fa.iconList["line-chart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget linkedin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1504" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("linkedin")) {
        body = Fa.iconList["linkedin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget linkedinSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("linkedin-square")) {
        body = Fa.iconList["linkedin-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget linode({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("linode")) {
        body = Fa.iconList["linode"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget linux({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("linux")) {
        body = Fa.iconList["linux"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget list({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("list")) {
        body = Fa.iconList["list"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget listAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("list-alt")) {
        body = Fa.iconList["list-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget listOl({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("list-ol")) {
        body = Fa.iconList["list-ol"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget listUl({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("list-ul")) {
        body = Fa.iconList["list-ul"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget locationArrow({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("location-arrow")) {
        body = Fa.iconList["location-arrow"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget lock({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("lock")) {
        body = Fa.iconList["lock"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget longArrowLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("long-arrow-left")) {
        body = Fa.iconList["long-arrow-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget longArrowUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 768 1728" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("long-arrow-up")) {
        body = Fa.iconList["long-arrow-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget lowVision({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("low-vision")) {
        body = Fa.iconList["low-vision"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget magic({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("magic")) {
        body = Fa.iconList["magic"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget magnet({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("magnet")) {
        body = Fa.iconList["magnet"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mailForward({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mail-forward")) {
        body = Fa.iconList["mail-forward"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mailReply({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mail-reply")) {
        body = Fa.iconList["mail-reply"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mailReplyAll({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mail-reply-all")) {
        body = Fa.iconList["mail-reply-all"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget male({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1760" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("male")) {
        body = Fa.iconList["male"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mapIcons({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("map")) {
        body = Fa.iconList["map"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mapMarker({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("map-marker")) {
        body = Fa.iconList["map-marker"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mapO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("map-o")) {
        body = Fa.iconList["map-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mapPin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("map-pin")) {
        body = Fa.iconList["map-pin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mapSigns({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("map-signs")) {
        body = Fa.iconList["map-signs"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mars({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mars")) {
        body = Fa.iconList["mars"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget marsDouble({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mars-double")) {
        body = Fa.iconList["mars-double"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget marsStroke({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mars-stroke")) {
        body = Fa.iconList["mars-stroke"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget marsStrokeH({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mars-stroke-h")) {
        body = Fa.iconList["mars-stroke-h"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget marsStrokeV({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mars-stroke-v")) {
        body = Fa.iconList["mars-stroke-v"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget maxcdn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1760 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("maxcdn")) {
        body = Fa.iconList["maxcdn"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget meanpath({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("meanpath")) {
        body = Fa.iconList["meanpath"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget medium({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("medium")) {
        body = Fa.iconList["medium"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget medkit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("medkit")) {
        body = Fa.iconList["medkit"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget meetup({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1856 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("meetup")) {
        body = Fa.iconList["meetup"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mehO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("meh-o")) {
        body = Fa.iconList["meh-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mercury({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mercury")) {
        body = Fa.iconList["mercury"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget microchip({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("microchip")) {
        body = Fa.iconList["microchip"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget microphone({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("microphone")) {
        body = Fa.iconList["microphone"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget microphoneSlash({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("microphone-slash")) {
        body = Fa.iconList["microphone-slash"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget minus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("minus")) {
        body = Fa.iconList["minus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget minusCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("minus-circle")) {
        body = Fa.iconList["minus-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget minusSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("minus-square")) {
        body = Fa.iconList["minus-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget minusSquareO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("minus-square-o")) {
        body = Fa.iconList["minus-square-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mixcloud({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mixcloud")) {
        body = Fa.iconList["mixcloud"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mobile({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 768 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mobile")) {
        body = Fa.iconList["mobile"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget modx({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("modx")) {
        body = Fa.iconList["modx"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget money({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("money")) {
        body = Fa.iconList["money"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget moonO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("moon-o")) {
        body = Fa.iconList["moon-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget motorcycle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("motorcycle")) {
        body = Fa.iconList["motorcycle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mousePointer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("mouse-pointer")) {
        body = Fa.iconList["mouse-pointer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget music({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("music")) {
        body = Fa.iconList["music"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget neuter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("neuter")) {
        body = Fa.iconList["neuter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget newspaperO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("newspaper-o")) {
        body = Fa.iconList["newspaper-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget objectGroup({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("object-group")) {
        body = Fa.iconList["object-group"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget objectUngroup({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("object-ungroup")) {
        body = Fa.iconList["object-ungroup"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget odnoklassniki({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1088 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("odnoklassniki")) {
        body = Fa.iconList["odnoklassniki"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget odnoklassnikiSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("odnoklassniki-square")) {
        body = Fa.iconList["odnoklassniki-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget opencart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2336 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("opencart")) {
        body = Fa.iconList["opencart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget openid({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("openid")) {
        body = Fa.iconList["openid"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget opera({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("opera")) {
        body = Fa.iconList["opera"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget optinMonster({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2176 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("optin-monster")) {
        body = Fa.iconList["optin-monster"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pagelines({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pagelines")) {
        body = Fa.iconList["pagelines"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget paintBrush({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("paint-brush")) {
        body = Fa.iconList["paint-brush"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget paperPlane({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("paper-plane")) {
        body = Fa.iconList["paper-plane"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget paperPlaneO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1824" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("paper-plane-o")) {
        body = Fa.iconList["paper-plane-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget paperclip({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("paperclip")) {
        body = Fa.iconList["paperclip"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget paragraph({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("paragraph")) {
        body = Fa.iconList["paragraph"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pause({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pause")) {
        body = Fa.iconList["pause"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pauseCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pause-circle")) {
        body = Fa.iconList["pause-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pauseCircleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pause-circle-o")) {
        body = Fa.iconList["pause-circle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget paw({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("paw")) {
        body = Fa.iconList["paw"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget paypal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("paypal")) {
        body = Fa.iconList["paypal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pencil({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pencil")) {
        body = Fa.iconList["pencil"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pencilSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pencil-square")) {
        body = Fa.iconList["pencil-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget percent({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("percent")) {
        body = Fa.iconList["percent"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget phone({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("phone")) {
        body = Fa.iconList["phone"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget phoneSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("phone-square")) {
        body = Fa.iconList["phone-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pieChart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pie-chart")) {
        body = Fa.iconList["pie-chart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget piedPiper({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pied-piper")) {
        body = Fa.iconList["pied-piper"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget piedPiperAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1984 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pied-piper-alt")) {
        body = Fa.iconList["pied-piper-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget piedPiperPp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pied-piper-pp")) {
        body = Fa.iconList["pied-piper-pp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pinterest({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pinterest")) {
        body = Fa.iconList["pinterest"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pinterestP({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pinterest-p")) {
        body = Fa.iconList["pinterest-p"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pinterestSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("pinterest-square")) {
        body = Fa.iconList["pinterest-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget plane({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("plane")) {
        body = Fa.iconList["plane"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget play({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("play")) {
        body = Fa.iconList["play"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget playCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("play-circle")) {
        body = Fa.iconList["play-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget playCircleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("play-circle-o")) {
        body = Fa.iconList["play-circle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget plug({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("plug")) {
        body = Fa.iconList["plug"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget plus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("plus")) {
        body = Fa.iconList["plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget plusCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("plus-circle")) {
        body = Fa.iconList["plus-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget plusSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("plus-square")) {
        body = Fa.iconList["plus-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget plusSquareO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("plus-square-o")) {
        body = Fa.iconList["plus-square-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget podcast({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("podcast")) {
        body = Fa.iconList["podcast"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget powerOff({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("power-off")) {
        body = Fa.iconList["power-off"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget print({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("print")) {
        body = Fa.iconList["print"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget productHunt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("product-hunt")) {
        body = Fa.iconList["product-hunt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget puzzlePiece({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("puzzle-piece")) {
        body = Fa.iconList["puzzle-piece"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget qq({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("qq")) {
        body = Fa.iconList["qq"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget qrcode({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("qrcode")) {
        body = Fa.iconList["qrcode"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget question({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 928 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("question")) {
        body = Fa.iconList["question"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget questionCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("question-circle")) {
        body = Fa.iconList["question-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget questionCircleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("question-circle-o")) {
        body = Fa.iconList["question-circle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget quora({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("quora")) {
        body = Fa.iconList["quora"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget quoteLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("quote-left")) {
        body = Fa.iconList["quote-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget quoteRight({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("quote-right")) {
        body = Fa.iconList["quote-right"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ra({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ra")) {
        body = Fa.iconList["ra"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget random({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("random")) {
        body = Fa.iconList["random"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ravelry({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2112 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ravelry")) {
        body = Fa.iconList["ravelry"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget recycle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1728" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("recycle")) {
        body = Fa.iconList["recycle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget reddit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("reddit")) {
        body = Fa.iconList["reddit"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget redditAlien({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1696" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("reddit-alien")) {
        body = Fa.iconList["reddit-alien"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget redditSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("reddit-square")) {
        body = Fa.iconList["reddit-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget refresh({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("refresh")) {
        body = Fa.iconList["refresh"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget registered({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("registered")) {
        body = Fa.iconList["registered"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget renren({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("renren")) {
        body = Fa.iconList["renren"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget repeat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("repeat")) {
        body = Fa.iconList["repeat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget retweet({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("retweet")) {
        body = Fa.iconList["retweet"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget road({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1856 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("road")) {
        body = Fa.iconList["road"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rocket({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1632" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("rocket")) {
        body = Fa.iconList["rocket"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget rotateLeft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("rotate-left")) {
        body = Fa.iconList["rotate-left"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rouble({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("rouble")) {
        body = Fa.iconList["rouble"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rssSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("rss-square")) {
        body = Fa.iconList["rss-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget safari({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("safari")) {
        body = Fa.iconList["safari"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget scribd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("scribd")) {
        body = Fa.iconList["scribd"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget search({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("search")) {
        body = Fa.iconList["search"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget searchMinus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("search-minus")) {
        body = Fa.iconList["search-minus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget searchPlus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("search-plus")) {
        body = Fa.iconList["search-plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sellsy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1472" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sellsy")) {
        body = Fa.iconList["sellsy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget server({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("server")) {
        body = Fa.iconList["server"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shareAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("share-alt")) {
        body = Fa.iconList["share-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget shareAltSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("share-alt-square")) {
        body = Fa.iconList["share-alt-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget shareSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("share-square")) {
        body = Fa.iconList["share-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget shareSquareO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("share-square-o")) {
        body = Fa.iconList["share-square-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shield({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("shield")) {
        body = Fa.iconList["shield"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ship({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ship")) {
        body = Fa.iconList["ship"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget shirtsinbulk({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1760" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("shirtsinbulk")) {
        body = Fa.iconList["shirtsinbulk"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shoppingBag({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("shopping-bag")) {
        body = Fa.iconList["shopping-bag"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shoppingBasket({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("shopping-basket")) {
        body = Fa.iconList["shopping-basket"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shoppingCart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("shopping-cart")) {
        body = Fa.iconList["shopping-cart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shower({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("shower")) {
        body = Fa.iconList["shower"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget signIn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sign-in")) {
        body = Fa.iconList["sign-in"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget signLanguage({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sign-language")) {
        body = Fa.iconList["sign-language"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget signOut({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1568 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sign-out")) {
        body = Fa.iconList["sign-out"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget signal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("signal")) {
        body = Fa.iconList["signal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget simplybuilt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("simplybuilt")) {
        body = Fa.iconList["simplybuilt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sitemap({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sitemap")) {
        body = Fa.iconList["sitemap"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget skyatlas({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("skyatlas")) {
        body = Fa.iconList["skyatlas"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget skype({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("skype")) {
        body = Fa.iconList["skype"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget slack({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("slack")) {
        body = Fa.iconList["slack"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sliders({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sliders")) {
        body = Fa.iconList["sliders"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget slideshare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("slideshare")) {
        body = Fa.iconList["slideshare"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget smileO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("smile-o")) {
        body = Fa.iconList["smile-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget snapchat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("snapchat")) {
        body = Fa.iconList["snapchat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget snapchatGhost({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("snapchat-ghost")) {
        body = Fa.iconList["snapchat-ghost"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget snapchatSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("snapchat-square")) {
        body = Fa.iconList["snapchat-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget snowflakeO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1600 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("snowflake-o")) {
        body = Fa.iconList["snowflake-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sort({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sort")) {
        body = Fa.iconList["sort"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sortAlphaAsc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1632 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sort-alpha-asc")) {
        body = Fa.iconList["sort-alpha-asc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sortAlphaDesc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1632 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sort-alpha-desc")) {
        body = Fa.iconList["sort-alpha-desc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sortAmountAsc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1760 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sort-amount-asc")) {
        body = Fa.iconList["sort-amount-asc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sortAmountDesc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1760 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sort-amount-desc")) {
        body = Fa.iconList["sort-amount-desc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sortAsc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1344" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sort-asc")) {
        body = Fa.iconList["sort-asc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sortNumericAsc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sort-numeric-asc")) {
        body = Fa.iconList["sort-numeric-asc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sortNumericDesc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sort-numeric-desc")) {
        body = Fa.iconList["sort-numeric-desc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget soundcloud({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("soundcloud")) {
        body = Fa.iconList["soundcloud"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget spaceShuttle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2176 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("space-shuttle")) {
        body = Fa.iconList["space-shuttle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget spinner({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1728" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("spinner")) {
        body = Fa.iconList["spinner"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget spoon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("spoon")) {
        body = Fa.iconList["spoon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget spotify({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("spotify")) {
        body = Fa.iconList["spotify"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget square({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("square")) {
        body = Fa.iconList["square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("square-o")) {
        body = Fa.iconList["square-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stackExchange({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("stack-exchange")) {
        body = Fa.iconList["stack-exchange"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stackOverflow({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("stack-overflow")) {
        body = Fa.iconList["stack-overflow"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget star({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("star")) {
        body = Fa.iconList["star"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget starHalf({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 832 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("star-half")) {
        body = Fa.iconList["star-half"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget starHalfEmpty({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("star-half-empty")) {
        body = Fa.iconList["star-half-empty"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget starO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("star-o")) {
        body = Fa.iconList["star-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget steam({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("steam")) {
        body = Fa.iconList["steam"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget steamSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("steam-square")) {
        body = Fa.iconList["steam-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stepBackward({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("step-backward")) {
        body = Fa.iconList["step-backward"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stethoscope({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("stethoscope")) {
        body = Fa.iconList["stethoscope"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stickyNote({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sticky-note")) {
        body = Fa.iconList["sticky-note"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stickyNoteO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sticky-note-o")) {
        body = Fa.iconList["sticky-note-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stop({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("stop")) {
        body = Fa.iconList["stop"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stopCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("stop-circle")) {
        body = Fa.iconList["stop-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stopCircleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("stop-circle-o")) {
        body = Fa.iconList["stop-circle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget streetView({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1760" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("street-view")) {
        body = Fa.iconList["street-view"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget strikethrough({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("strikethrough")) {
        body = Fa.iconList["strikethrough"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stumbleupon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 1472" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("stumbleupon")) {
        body = Fa.iconList["stumbleupon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stumbleuponCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("stumbleupon-circle")) {
        body = Fa.iconList["stumbleupon-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget subscript({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("subscript")) {
        body = Fa.iconList["subscript"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget subway({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("subway")) {
        body = Fa.iconList["subway"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget suitcase({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("suitcase")) {
        body = Fa.iconList["suitcase"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sunO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("sun-o")) {
        body = Fa.iconList["sun-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget superpowers({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("superpowers")) {
        body = Fa.iconList["superpowers"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget superscript({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("superscript")) {
        body = Fa.iconList["superscript"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget table({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("table")) {
        body = Fa.iconList["table"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tablet({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tablet")) {
        body = Fa.iconList["tablet"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tag({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tag")) {
        body = Fa.iconList["tag"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tags({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tags")) {
        body = Fa.iconList["tags"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tasks({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tasks")) {
        body = Fa.iconList["tasks"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget telegram({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("telegram")) {
        body = Fa.iconList["telegram"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget television({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1920 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("television")) {
        body = Fa.iconList["television"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tencentWeibo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1216 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tencent-weibo")) {
        body = Fa.iconList["tencent-weibo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget terminal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("terminal")) {
        body = Fa.iconList["terminal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget textHeight({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("text-height")) {
        body = Fa.iconList["text-height"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget textWidth({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("text-width")) {
        body = Fa.iconList["text-width"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget th({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("th")) {
        body = Fa.iconList["th"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thLarge({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("th-large")) {
        body = Fa.iconList["th-large"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thList({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("th-list")) {
        body = Fa.iconList["th-list"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget themeisle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("themeisle")) {
        body = Fa.iconList["themeisle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget thermometer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("thermometer")) {
        body = Fa.iconList["thermometer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thermometer0({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("thermometer-0")) {
        body = Fa.iconList["thermometer-0"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thermometer1({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("thermometer-1")) {
        body = Fa.iconList["thermometer-1"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thermometer2({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("thermometer-2")) {
        body = Fa.iconList["thermometer-2"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thermometer3({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("thermometer-3")) {
        body = Fa.iconList["thermometer-3"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thumbTack({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("thumb-tack")) {
        body = Fa.iconList["thumb-tack"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thumbsDown({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1600 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("thumbs-down")) {
        body = Fa.iconList["thumbs-down"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thumbsOUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("thumbs-o-up")) {
        body = Fa.iconList["thumbs-o-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget thumbsUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1600 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("thumbs-up")) {
        body = Fa.iconList["thumbs-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ticket({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1728" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("ticket")) {
        body = Fa.iconList["ticket"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget timesCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("times-circle")) {
        body = Fa.iconList["times-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget timesCircleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("times-circle-o")) {
        body = Fa.iconList["times-circle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget timesRectangle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("times-rectangle")) {
        body = Fa.iconList["times-rectangle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget timesRectangleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("times-rectangle-o")) {
        body = Fa.iconList["times-rectangle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tint({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1024 1472" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tint")) {
        body = Fa.iconList["tint"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget toggleOff({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("toggle-off")) {
        body = Fa.iconList["toggle-off"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget toggleOn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("toggle-on")) {
        body = Fa.iconList["toggle-on"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget trademark({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1984 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("trademark")) {
        body = Fa.iconList["trademark"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget train({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("train")) {
        body = Fa.iconList["train"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget transgenderAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("transgender-alt")) {
        body = Fa.iconList["transgender-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget trash({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("trash")) {
        body = Fa.iconList["trash"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget trashO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("trash-o")) {
        body = Fa.iconList["trash-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tree({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tree")) {
        body = Fa.iconList["tree"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget trello({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("trello")) {
        body = Fa.iconList["trello"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tripadvisor({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tripadvisor")) {
        body = Fa.iconList["tripadvisor"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget trophy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("trophy")) {
        body = Fa.iconList["trophy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget truck({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1728 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("truck")) {
        body = Fa.iconList["truck"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tryIcon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("try")) {
        body = Fa.iconList["try"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tty({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tty")) {
        body = Fa.iconList["tty"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tumblr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 960 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tumblr")) {
        body = Fa.iconList["tumblr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tumblrSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("tumblr-square")) {
        body = Fa.iconList["tumblr-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget twitch({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1600 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("twitch")) {
        body = Fa.iconList["twitch"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget twitter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1600 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("twitter")) {
        body = Fa.iconList["twitter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget twitterSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("twitter-square")) {
        body = Fa.iconList["twitter-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget umbrella({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("umbrella")) {
        body = Fa.iconList["umbrella"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget underline({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("underline")) {
        body = Fa.iconList["underline"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget universalAccess({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("universal-access")) {
        body = Fa.iconList["universal-access"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget unlock({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("unlock")) {
        body = Fa.iconList["unlock"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget unlockAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("unlock-alt")) {
        body = Fa.iconList["unlock-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget upload({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("upload")) {
        body = Fa.iconList["upload"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget usb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("usb")) {
        body = Fa.iconList["usb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget user({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("user")) {
        body = Fa.iconList["user"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget userCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("user-circle")) {
        body = Fa.iconList["user-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userCircleO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("user-circle-o")) {
        body = Fa.iconList["user-circle-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userMd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("user-md")) {
        body = Fa.iconList["user-md"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userO({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("user-o")) {
        body = Fa.iconList["user-o"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget userPlus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("user-plus")) {
        body = Fa.iconList["user-plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userSecret({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("user-secret")) {
        body = Fa.iconList["user-secret"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget userTimes({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("user-times")) {
        body = Fa.iconList["user-times"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget venus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("venus")) {
        body = Fa.iconList["venus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget venusDouble({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("venus-double")) {
        body = Fa.iconList["venus-double"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget venusMars({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("venus-mars")) {
        body = Fa.iconList["venus-mars"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget viacoin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("viacoin")) {
        body = Fa.iconList["viacoin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget viadeo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1280 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("viadeo")) {
        body = Fa.iconList["viadeo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget viadeoSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("viadeo-square")) {
        body = Fa.iconList["viadeo-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget videoCamera({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("video-camera")) {
        body = Fa.iconList["video-camera"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget vimeo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("vimeo")) {
        body = Fa.iconList["vimeo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget vimeoSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("vimeo-square")) {
        body = Fa.iconList["vimeo-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget vine({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1472 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("vine")) {
        body = Fa.iconList["vine"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget vk({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1952 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("vk")) {
        body = Fa.iconList["vk"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget volumeControlPhone({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("volume-control-phone")) {
        body = Fa.iconList["volume-control-phone"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget volumeDown({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1152 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("volume-down")) {
        body = Fa.iconList["volume-down"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget volumeOff({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 768 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("volume-off")) {
        body = Fa.iconList["volume-off"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget volumeUp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1472" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("volume-up")) {
        body = Fa.iconList["volume-up"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wechat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1728" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wechat")) {
        body = Fa.iconList["wechat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget weibo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1472" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("weibo")) {
        body = Fa.iconList["weibo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget whatsapp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1600" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("whatsapp")) {
        body = Fa.iconList["whatsapp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wheelchair({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1632 1760" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wheelchair")) {
        body = Fa.iconList["wheelchair"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wheelchairAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wheelchair-alt")) {
        body = Fa.iconList["wheelchair-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wifi({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1984 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wifi")) {
        body = Fa.iconList["wifi"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wikipediaW({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2304 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wikipedia-w")) {
        body = Fa.iconList["wikipedia-w"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget windowMaximize({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("window-maximize")) {
        body = Fa.iconList["window-maximize"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget windowMinimize({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1408" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("window-minimize")) {
        body = Fa.iconList["window-minimize"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget windowRestore({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 2048 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("window-restore")) {
        body = Fa.iconList["window-restore"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget windows({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("windows")) {
        body = Fa.iconList["windows"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wordpress({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wordpress")) {
        body = Fa.iconList["wordpress"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wpbeginner({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1728" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wpbeginner")) {
        body = Fa.iconList["wpbeginner"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wpexplorer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wpexplorer")) {
        body = Fa.iconList["wpexplorer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wpforms({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wpforms")) {
        body = Fa.iconList["wpforms"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wrench({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("wrench")) {
        body = Fa.iconList["wrench"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget xing({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("xing")) {
        body = Fa.iconList["xing"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget xingSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("xing-square")) {
        body = Fa.iconList["xing-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget yCombinator({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("y-combinator")) {
        body = Fa.iconList["y-combinator"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget yahoo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1344 1664" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("yahoo")) {
        body = Fa.iconList["yahoo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget yelp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1408 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("yelp")) {
        body = Fa.iconList["yelp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget yoast({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1664 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("yoast")) {
        body = Fa.iconList["yoast"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget youtube({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 1792" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("youtube")) {
        body = Fa.iconList["youtube"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget youtubePlay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 1792 1280" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("youtube-play")) {
        body = Fa.iconList["youtube-play"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget youtubeSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa.iconList.containsKey("youtube-square")) {
        body = Fa.iconList["youtube-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Map<String,Widget Function({double? width,double? height,Color? color})> names  =   {
    ...
    "address-book-o":addressBookO,
    "address-card":addressCard,
    "address-card-o":addressCardO,
    "adjust":adjust,
    "adn":adn,
    ...
    "arrow-circle-o-left":arrowCircleOLeft,
    "arrow-circle-o-up":arrowCircleOUp,
    ...
    "bell-slash-o":bellSlashO,
    "bicycle":bicycle,
    "binoculars":binoculars,
    "birthday-cake":birthdayCake,
    "bitbucket":bitbucket,
    "bitbucket-square":bitbucketSquare,
    "bitcoin":bitcoin,
    "black-tie":blackTie,
    "blind":blind,
    "bluetooth":bluetooth,
    ...
    "calendar":calendar,
    "calendar-check-o":calendarCheckO,
    "calendar-minus-o":calendarMinusO,
    "calendar-o":calendarO,
    "calendar-plus-o":calendarPlusO,
    "calendar-times-o":calendarTimesO,
    "camera":camera,
    "camera-retro":cameraRetro,
    "caret-down":caretDown,
    "caret-left":caretLeft,
    "caret-square-o-left":caretSquareOLeft,
    "caret-square-o-up":caretSquareOUp,
    "caret-up":caretUp,
    ...
    "circle":circle,
    "circle-o":circleO,
    "circle-o-notch":circleONotch,
    "circle-thin":circleThin,
    "clipboard":clipboard,
    "clock-o":clockO,
    "clone":clone,
    "close":close,
    ...
    "commenting-o":commentingO,
    "comments":comments,
    "comments-o":commentsO,
    "compass":compass,
    "compress":compress,
    ...
    "digg":digg,
    "dollar":dollar,
    "dot-circle-o":dotCircleO,
    "download":download,
    "dribbble":dribbble,
    "drivers-license":driversLicense,
    "drivers-license-o":driversLicenseO,
    "dropbox":dropbox,
    "drupal":drupal,
    "edge":edge,
    "edit":edit,
    ...
    "hand-grab-o":handGrabO,
    "hand-lizard-o":handLizardO,
    "hand-o-left":handOLeft,
    "hand-o-up":handOUp,
    "hand-paper-o":handPaperO,
    "hand-peace-o":handPeaceO,
    "hand-pointer-o":handPointerO,
    "hand-scissors-o":handScissorsO,
    "hand-spock-o":handSpockO,
    "handshake-o":handshakeO,
    "hashtag":hashtag,
    "hdd-o":hddO,
    "header":header,
    ...
    "paper-plane-o":paperPlaneO,
    "paperclip":paperclip,
    "paragraph":paragraph,
    "pause":pause,
    "pause-circle":pauseCircle,
    "pause-circle-o":pauseCircleO,
    "paw":paw,
    "paypal":paypal,
    "pencil":pencil,
    ...
    "snowflake-o":snowflakeO,
    "sort":sort,
    "sort-alpha-asc":sortAlphaAsc,
    "sort-alpha-desc":sortAlphaDesc,
    "sort-amount-asc":sortAmountAsc,
    "sort-amount-desc":sortAmountDesc,
    "sort-asc":sortAsc,
    "sort-numeric-asc":sortNumericAsc,
    "sort-numeric-desc":sortNumericDesc,
    ...
    "sticky-note-o":stickyNoteO,
    "stop":stop,
    "stop-circle":stopCircle,
    "stop-circle-o":stopCircleO,
    ...
    "times-rectangle":timesRectangle,
    "times-rectangle-o":timesRectangleO,
    "tint":tint,
    ...
    "vine":vine,
    "vk":vk,
    "volume-control-phone":volumeControlPhone,
