...
// fa6-brands 6.7.2 icon package is licensed under CC-BY-4.0 https://creativecommons.org/licenses/by/4.0/, {Dave Gandy https://github.com/FortAwesome/Font-Awesome}
// 
...
static Widget getIcon(String name,{double? width,double? height,Color? color}) {
    return Fa6Brands.names[name]!(width:width,height:height,color:color);
}


static Widget i42Group({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("42-group")) {
        body = Fa6Brands.iconList["42-group"]!;
    }
...
static Widget i500Px({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Fa6Brands.iconList.containsKey("500px")) {
        body = Fa6Brands.iconList["500px"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget accessibleIcon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("accessible-icon")) {
        body = Fa6Brands.iconList["accessible-icon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget accusoft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("accusoft")) {
        body = Fa6Brands.iconList["accusoft"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget adn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("adn")) {
        body = Fa6Brands.iconList["adn"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget adversal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("adversal")) {
        body = Fa6Brands.iconList["adversal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget affiliatetheme({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("affiliatetheme")) {
        body = Fa6Brands.iconList["affiliatetheme"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget airbnb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("airbnb")) {
        body = Fa6Brands.iconList["airbnb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget algolia({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("algolia")) {
        body = Fa6Brands.iconList["algolia"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget alipay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("alipay")) {
        body = Fa6Brands.iconList["alipay"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget amazon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("amazon")) {
        body = Fa6Brands.iconList["amazon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget amazonPay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("amazon-pay")) {
        body = Fa6Brands.iconList["amazon-pay"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget amilia({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("amilia")) {
        body = Fa6Brands.iconList["amilia"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget android({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("android")) {
        body = Fa6Brands.iconList["android"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget angellist({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("angellist")) {
        body = Fa6Brands.iconList["angellist"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget angrycreative({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("angrycreative")) {
        body = Fa6Brands.iconList["angrycreative"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget angular({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("angular")) {
        body = Fa6Brands.iconList["angular"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget appStore({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("app-store")) {
        body = Fa6Brands.iconList["app-store"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget appStoreIos({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("app-store-ios")) {
        body = Fa6Brands.iconList["app-store-ios"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget apper({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("apper")) {
        body = Fa6Brands.iconList["apper"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget apple({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("apple")) {
        body = Fa6Brands.iconList["apple"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget applePay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("apple-pay")) {
        body = Fa6Brands.iconList["apple-pay"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget artstation({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("artstation")) {
        body = Fa6Brands.iconList["artstation"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget asymmetrik({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("asymmetrik")) {
        body = Fa6Brands.iconList["asymmetrik"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget atlassian({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("atlassian")) {
        body = Fa6Brands.iconList["atlassian"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget audible({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("audible")) {
        body = Fa6Brands.iconList["audible"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget autoprefixer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("autoprefixer")) {
        body = Fa6Brands.iconList["autoprefixer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget avianex({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("avianex")) {
        body = Fa6Brands.iconList["avianex"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget aviato({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("aviato")) {
        body = Fa6Brands.iconList["aviato"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget aws({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("aws")) {
        body = Fa6Brands.iconList["aws"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bandcamp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bandcamp")) {
        body = Fa6Brands.iconList["bandcamp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget battleNet({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("battle-net")) {
        body = Fa6Brands.iconList["battle-net"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget behance({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("behance")) {
        body = Fa6Brands.iconList["behance"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bilibili({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bilibili")) {
        body = Fa6Brands.iconList["bilibili"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bimobject({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bimobject")) {
        body = Fa6Brands.iconList["bimobject"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bitbucket({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bitbucket")) {
        body = Fa6Brands.iconList["bitbucket"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bitcoin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bitcoin")) {
        body = Fa6Brands.iconList["bitcoin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bity({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bity")) {
        body = Fa6Brands.iconList["bity"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget blackTie({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("black-tie")) {
        body = Fa6Brands.iconList["black-tie"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget blackberry({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("blackberry")) {
        body = Fa6Brands.iconList["blackberry"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget blogger({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("blogger")) {
        body = Fa6Brands.iconList["blogger"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bloggerB({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("blogger-b")) {
        body = Fa6Brands.iconList["blogger-b"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bluesky({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bluesky")) {
        body = Fa6Brands.iconList["bluesky"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bluetooth({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bluetooth")) {
        body = Fa6Brands.iconList["bluetooth"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bluetoothB({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bluetooth-b")) {
        body = Fa6Brands.iconList["bluetooth-b"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bootstrap({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bootstrap")) {
        body = Fa6Brands.iconList["bootstrap"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget bots({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("bots")) {
        body = Fa6Brands.iconList["bots"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget brave({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("brave")) {
        body = Fa6Brands.iconList["brave"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget braveReverse({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("brave-reverse")) {
        body = Fa6Brands.iconList["brave-reverse"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget btc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("btc")) {
        body = Fa6Brands.iconList["btc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget buffer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("buffer")) {
        body = Fa6Brands.iconList["buffer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget buromobelexperte({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("buromobelexperte")) {
        body = Fa6Brands.iconList["buromobelexperte"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget buyNLarge({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("buy-n-large")) {
        body = Fa6Brands.iconList["buy-n-large"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget buysellads({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("buysellads")) {
        body = Fa6Brands.iconList["buysellads"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget canadianMapleLeaf({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("canadian-maple-leaf")) {
        body = Fa6Brands.iconList["canadian-maple-leaf"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccAmazonPay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-amazon-pay")) {
        body = Fa6Brands.iconList["cc-amazon-pay"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ccAmex({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-amex")) {
        body = Fa6Brands.iconList["cc-amex"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ccApplePay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-apple-pay")) {
        body = Fa6Brands.iconList["cc-apple-pay"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ccDinersClub({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-diners-club")) {
        body = Fa6Brands.iconList["cc-diners-club"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ccDiscover({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-discover")) {
        body = Fa6Brands.iconList["cc-discover"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ccJcb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-jcb")) {
        body = Fa6Brands.iconList["cc-jcb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ccMastercard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-mastercard")) {
        body = Fa6Brands.iconList["cc-mastercard"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ccPaypal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-paypal")) {
        body = Fa6Brands.iconList["cc-paypal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ccStripe({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-stripe")) {
        body = Fa6Brands.iconList["cc-stripe"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ccVisa({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cc-visa")) {
        body = Fa6Brands.iconList["cc-visa"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget centercode({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("centercode")) {
        body = Fa6Brands.iconList["centercode"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget centos({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("centos")) {
        body = Fa6Brands.iconList["centos"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget chrome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("chrome")) {
        body = Fa6Brands.iconList["chrome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget chromecast({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("chromecast")) {
        body = Fa6Brands.iconList["chromecast"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cloudflare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cloudflare")) {
        body = Fa6Brands.iconList["cloudflare"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cloudscale({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cloudscale")) {
        body = Fa6Brands.iconList["cloudscale"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cloudsmith({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cloudsmith")) {
        body = Fa6Brands.iconList["cloudsmith"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cloudversify({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 616 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cloudversify")) {
        body = Fa6Brands.iconList["cloudversify"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cmplid({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cmplid")) {
        body = Fa6Brands.iconList["cmplid"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget codepen({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("codepen")) {
        body = Fa6Brands.iconList["codepen"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget codiepie({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 472 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("codiepie")) {
        body = Fa6Brands.iconList["codiepie"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget confluence({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("confluence")) {
        body = Fa6Brands.iconList["confluence"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget connectdevelop({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("connectdevelop")) {
        body = Fa6Brands.iconList["connectdevelop"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget contao({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("contao")) {
        body = Fa6Brands.iconList["contao"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cottonBureau({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cotton-bureau")) {
        body = Fa6Brands.iconList["cotton-bureau"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cpanel({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cpanel")) {
        body = Fa6Brands.iconList["cpanel"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget creativeCommons({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons")) {
        body = Fa6Brands.iconList["creative-commons"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsBy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-by")) {
        body = Fa6Brands.iconList["creative-commons-by"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsNc({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-nc")) {
        body = Fa6Brands.iconList["creative-commons-nc"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsNcEu({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-nc-eu")) {
        body = Fa6Brands.iconList["creative-commons-nc-eu"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsNcJp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-nc-jp")) {
        body = Fa6Brands.iconList["creative-commons-nc-jp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsNd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-nd")) {
        body = Fa6Brands.iconList["creative-commons-nd"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsPd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-pd")) {
        body = Fa6Brands.iconList["creative-commons-pd"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsPdAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-pd-alt")) {
        body = Fa6Brands.iconList["creative-commons-pd-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsRemix({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-remix")) {
        body = Fa6Brands.iconList["creative-commons-remix"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsSa({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-sa")) {
        body = Fa6Brands.iconList["creative-commons-sa"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsSampling({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-sampling")) {
        body = Fa6Brands.iconList["creative-commons-sampling"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsSamplingPlus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-sampling-plus")) {
        body = Fa6Brands.iconList["creative-commons-sampling-plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsShare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-share")) {
        body = Fa6Brands.iconList["creative-commons-share"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget creativeCommonsZero({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("creative-commons-zero")) {
        body = Fa6Brands.iconList["creative-commons-zero"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget criticalRole({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("critical-role")) {
        body = Fa6Brands.iconList["critical-role"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget css({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("css")) {
        body = Fa6Brands.iconList["css"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget css3({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("css3")) {
        body = Fa6Brands.iconList["css3"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget css3Alt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("css3-alt")) {
        body = Fa6Brands.iconList["css3-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cuttlefish({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 440 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("cuttlefish")) {
        body = Fa6Brands.iconList["cuttlefish"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dAndD({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("d-and-d")) {
        body = Fa6Brands.iconList["d-and-d"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dAndDBeyond({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("d-and-d-beyond")) {
        body = Fa6Brands.iconList["d-and-d-beyond"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dailymotion({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("dailymotion")) {
        body = Fa6Brands.iconList["dailymotion"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dartLang({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("dart-lang")) {
        body = Fa6Brands.iconList["dart-lang"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget dashcube({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("dashcube")) {
        body = Fa6Brands.iconList["dashcube"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget debian({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("debian")) {
        body = Fa6Brands.iconList["debian"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget deezer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("deezer")) {
        body = Fa6Brands.iconList["deezer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget delicious({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("delicious")) {
        body = Fa6Brands.iconList["delicious"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget deploydog({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("deploydog")) {
        body = Fa6Brands.iconList["deploydog"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget deskpro({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 480 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("deskpro")) {
        body = Fa6Brands.iconList["deskpro"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dev({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("dev")) {
        body = Fa6Brands.iconList["dev"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget deviantart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("deviantart")) {
        body = Fa6Brands.iconList["deviantart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dhl({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("dhl")) {
        body = Fa6Brands.iconList["dhl"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget diaspora({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("diaspora")) {
        body = Fa6Brands.iconList["diaspora"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget digg({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("digg")) {
        body = Fa6Brands.iconList["digg"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget digitalOcean({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("digital-ocean")) {
        body = Fa6Brands.iconList["digital-ocean"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget discord({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("discord")) {
        body = Fa6Brands.iconList["discord"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget discourse({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("discourse")) {
        body = Fa6Brands.iconList["discourse"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dochub({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 416 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("dochub")) {
        body = Fa6Brands.iconList["dochub"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget docker({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("docker")) {
        body = Fa6Brands.iconList["docker"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget draft2digital({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 480 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("draft2digital")) {
        body = Fa6Brands.iconList["draft2digital"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget dribbble({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("dribbble")) {
        body = Fa6Brands.iconList["dribbble"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dropbox({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 528 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("dropbox")) {
        body = Fa6Brands.iconList["dropbox"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget drupal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("drupal")) {
        body = Fa6Brands.iconList["drupal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget dyalog({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 416 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("dyalog")) {
        body = Fa6Brands.iconList["dyalog"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget earlybirds({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 480 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("earlybirds")) {
        body = Fa6Brands.iconList["earlybirds"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ebay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ebay")) {
        body = Fa6Brands.iconList["ebay"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget edge({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("edge")) {
        body = Fa6Brands.iconList["edge"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget edgeLegacy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("edge-legacy")) {
        body = Fa6Brands.iconList["edge-legacy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget elementor({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("elementor")) {
        body = Fa6Brands.iconList["elementor"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ello({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ello")) {
        body = Fa6Brands.iconList["ello"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ember({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ember")) {
        body = Fa6Brands.iconList["ember"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget empire({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("empire")) {
        body = Fa6Brands.iconList["empire"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget envira({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("envira")) {
        body = Fa6Brands.iconList["envira"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget erlang({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("erlang")) {
        body = Fa6Brands.iconList["erlang"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ethereum({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ethereum")) {
        body = Fa6Brands.iconList["ethereum"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget etsy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("etsy")) {
        body = Fa6Brands.iconList["etsy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget evernote({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("evernote")) {
        body = Fa6Brands.iconList["evernote"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget expeditedssl({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("expeditedssl")) {
        body = Fa6Brands.iconList["expeditedssl"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget facebook({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("facebook")) {
        body = Fa6Brands.iconList["facebook"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget facebookF({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("facebook-f")) {
        body = Fa6Brands.iconList["facebook-f"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget facebookMessenger({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("facebook-messenger")) {
        body = Fa6Brands.iconList["facebook-messenger"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fantasyFlightGames({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("fantasy-flight-games")) {
        body = Fa6Brands.iconList["fantasy-flight-games"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fedex({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("fedex")) {
        body = Fa6Brands.iconList["fedex"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget fedora({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("fedora")) {
        body = Fa6Brands.iconList["fedora"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget figma({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("figma")) {
        body = Fa6Brands.iconList["figma"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget filesPinwheel({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("files-pinwheel")) {
        body = Fa6Brands.iconList["files-pinwheel"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget firefox({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("firefox")) {
        body = Fa6Brands.iconList["firefox"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget firefoxBrowser({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("firefox-browser")) {
        body = Fa6Brands.iconList["firefox-browser"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget firstOrder({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("first-order")) {
        body = Fa6Brands.iconList["first-order"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget firstOrderAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("first-order-alt")) {
        body = Fa6Brands.iconList["first-order-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget firstdraft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("firstdraft")) {
        body = Fa6Brands.iconList["firstdraft"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget flickr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("flickr")) {
        body = Fa6Brands.iconList["flickr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget flipboard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("flipboard")) {
        body = Fa6Brands.iconList["flipboard"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget flutter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("flutter")) {
        body = Fa6Brands.iconList["flutter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fly({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("fly")) {
        body = Fa6Brands.iconList["fly"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fontAwesome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("font-awesome")) {
        body = Fa6Brands.iconList["font-awesome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget fonticons({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("fonticons")) {
        body = Fa6Brands.iconList["fonticons"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fonticonsFi({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("fonticons-fi")) {
        body = Fa6Brands.iconList["fonticons-fi"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget fortAwesome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("fort-awesome")) {
        body = Fa6Brands.iconList["fort-awesome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fortAwesomeAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("fort-awesome-alt")) {
        body = Fa6Brands.iconList["fort-awesome-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget forumbee({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("forumbee")) {
        body = Fa6Brands.iconList["forumbee"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget foursquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 368 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("foursquare")) {
        body = Fa6Brands.iconList["foursquare"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget freeCodeCamp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("free-code-camp")) {
        body = Fa6Brands.iconList["free-code-camp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget freebsd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("freebsd")) {
        body = Fa6Brands.iconList["freebsd"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget fulcrum({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("fulcrum")) {
        body = Fa6Brands.iconList["fulcrum"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget galacticRepublic({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("galactic-republic")) {
        body = Fa6Brands.iconList["galactic-republic"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget galacticSenate({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("galactic-senate")) {
        body = Fa6Brands.iconList["galactic-senate"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget getPocket({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("get-pocket")) {
        body = Fa6Brands.iconList["get-pocket"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget gg({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("gg")) {
        body = Fa6Brands.iconList["gg"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ggCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("gg-circle")) {
        body = Fa6Brands.iconList["gg-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget git({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("git")) {
        body = Fa6Brands.iconList["git"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gitAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("git-alt")) {
        body = Fa6Brands.iconList["git-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget github({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("github")) {
        body = Fa6Brands.iconList["github"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget githubAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 480 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("github-alt")) {
        body = Fa6Brands.iconList["github-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gitkraken({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 592 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("gitkraken")) {
        body = Fa6Brands.iconList["gitkraken"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget gitlab({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("gitlab")) {
        body = Fa6Brands.iconList["gitlab"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gitter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("gitter")) {
        body = Fa6Brands.iconList["gitter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget glide({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("glide")) {
        body = Fa6Brands.iconList["glide"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget glideG({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("glide-g")) {
        body = Fa6Brands.iconList["glide-g"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gofore({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 400 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("gofore")) {
        body = Fa6Brands.iconList["gofore"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget golang({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("golang")) {
        body = Fa6Brands.iconList["golang"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget goodreads({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("goodreads")) {
        body = Fa6Brands.iconList["goodreads"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget goodreadsG({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("goodreads-g")) {
        body = Fa6Brands.iconList["goodreads-g"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget google({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 488 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("google")) {
        body = Fa6Brands.iconList["google"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget googleDrive({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("google-drive")) {
        body = Fa6Brands.iconList["google-drive"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget googlePay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("google-pay")) {
        body = Fa6Brands.iconList["google-pay"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget googlePlay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("google-play")) {
        body = Fa6Brands.iconList["google-play"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget googlePlus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("google-plus")) {
        body = Fa6Brands.iconList["google-plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget googlePlusG({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("google-plus-g")) {
        body = Fa6Brands.iconList["google-plus-g"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget googleScholar({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("google-scholar")) {
        body = Fa6Brands.iconList["google-scholar"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget googleWallet({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("google-wallet")) {
        body = Fa6Brands.iconList["google-wallet"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gratipay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("gratipay")) {
        body = Fa6Brands.iconList["gratipay"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget grav({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("grav")) {
        body = Fa6Brands.iconList["grav"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gripfire({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("gripfire")) {
        body = Fa6Brands.iconList["gripfire"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget grunt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("grunt")) {
        body = Fa6Brands.iconList["grunt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget guilded({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("guilded")) {
        body = Fa6Brands.iconList["guilded"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gulp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 256 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("gulp")) {
        body = Fa6Brands.iconList["gulp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget hackerNews({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hacker-news")) {
        body = Fa6Brands.iconList["hacker-news"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hackerrank({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hackerrank")) {
        body = Fa6Brands.iconList["hackerrank"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hashnode({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hashnode")) {
        body = Fa6Brands.iconList["hashnode"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hips({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hips")) {
        body = Fa6Brands.iconList["hips"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hireAHelper({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hire-a-helper")) {
        body = Fa6Brands.iconList["hire-a-helper"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hive({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hive")) {
        body = Fa6Brands.iconList["hive"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hooli({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hooli")) {
        body = Fa6Brands.iconList["hooli"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hornbill({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hornbill")) {
        body = Fa6Brands.iconList["hornbill"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hotjar({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hotjar")) {
        body = Fa6Brands.iconList["hotjar"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget houzz({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("houzz")) {
        body = Fa6Brands.iconList["houzz"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget html5({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("html5")) {
        body = Fa6Brands.iconList["html5"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget hubspot({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("hubspot")) {
        body = Fa6Brands.iconList["hubspot"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ideal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ideal")) {
        body = Fa6Brands.iconList["ideal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget imdb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("imdb")) {
        body = Fa6Brands.iconList["imdb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget instagram({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("instagram")) {
        body = Fa6Brands.iconList["instagram"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget instalod({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("instalod")) {
        body = Fa6Brands.iconList["instalod"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget intercom({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("intercom")) {
        body = Fa6Brands.iconList["intercom"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget internetExplorer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("internet-explorer")) {
        body = Fa6Brands.iconList["internet-explorer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget invision({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("invision")) {
        body = Fa6Brands.iconList["invision"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ioxhost({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ioxhost")) {
        body = Fa6Brands.iconList["ioxhost"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget itchIo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("itch-io")) {
        body = Fa6Brands.iconList["itch-io"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget itunes({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("itunes")) {
        body = Fa6Brands.iconList["itunes"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget itunesNote({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("itunes-note")) {
        body = Fa6Brands.iconList["itunes-note"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget java({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("java")) {
        body = Fa6Brands.iconList["java"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget jediOrder({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("jedi-order")) {
        body = Fa6Brands.iconList["jedi-order"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget jenkins({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("jenkins")) {
        body = Fa6Brands.iconList["jenkins"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget jira({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("jira")) {
        body = Fa6Brands.iconList["jira"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget joget({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("joget")) {
        body = Fa6Brands.iconList["joget"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget joomla({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("joomla")) {
        body = Fa6Brands.iconList["joomla"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget js({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("js")) {
        body = Fa6Brands.iconList["js"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget jsfiddle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("jsfiddle")) {
        body = Fa6Brands.iconList["jsfiddle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget jxl({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("jxl")) {
        body = Fa6Brands.iconList["jxl"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kaggle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("kaggle")) {
        body = Fa6Brands.iconList["kaggle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget keybase({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("keybase")) {
        body = Fa6Brands.iconList["keybase"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget keycdn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("keycdn")) {
        body = Fa6Brands.iconList["keycdn"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kickstarter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("kickstarter")) {
        body = Fa6Brands.iconList["kickstarter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget kickstarterK({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("kickstarter-k")) {
        body = Fa6Brands.iconList["kickstarter-k"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget korvue({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 446 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("korvue")) {
        body = Fa6Brands.iconList["korvue"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget laravel({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("laravel")) {
        body = Fa6Brands.iconList["laravel"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget lastfm({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("lastfm")) {
        body = Fa6Brands.iconList["lastfm"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget leanpub({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("leanpub")) {
        body = Fa6Brands.iconList["leanpub"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget less({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("less")) {
        body = Fa6Brands.iconList["less"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget letterboxd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("letterboxd")) {
        body = Fa6Brands.iconList["letterboxd"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget line({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("line")) {
        body = Fa6Brands.iconList["line"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget linkedin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("linkedin")) {
        body = Fa6Brands.iconList["linkedin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget linkedinIn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("linkedin-in")) {
        body = Fa6Brands.iconList["linkedin-in"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget linode({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("linode")) {
        body = Fa6Brands.iconList["linode"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget linux({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("linux")) {
        body = Fa6Brands.iconList["linux"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget lyft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("lyft")) {
        body = Fa6Brands.iconList["lyft"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget magento({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("magento")) {
        body = Fa6Brands.iconList["magento"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mailchimp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mailchimp")) {
        body = Fa6Brands.iconList["mailchimp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mandalorian({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mandalorian")) {
        body = Fa6Brands.iconList["mandalorian"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget markdown({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("markdown")) {
        body = Fa6Brands.iconList["markdown"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mastodon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mastodon")) {
        body = Fa6Brands.iconList["mastodon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget maxcdn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("maxcdn")) {
        body = Fa6Brands.iconList["maxcdn"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mdb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mdb")) {
        body = Fa6Brands.iconList["mdb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget medapps({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("medapps")) {
        body = Fa6Brands.iconList["medapps"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget medium({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("medium")) {
        body = Fa6Brands.iconList["medium"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget medrt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 544 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("medrt")) {
        body = Fa6Brands.iconList["medrt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget meetup({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("meetup")) {
        body = Fa6Brands.iconList["meetup"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget megaport({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("megaport")) {
        body = Fa6Brands.iconList["megaport"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mendeley({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mendeley")) {
        body = Fa6Brands.iconList["mendeley"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget meta({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("meta")) {
        body = Fa6Brands.iconList["meta"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget microblog({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("microblog")) {
        body = Fa6Brands.iconList["microblog"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget microsoft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("microsoft")) {
        body = Fa6Brands.iconList["microsoft"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mintbit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mintbit")) {
        body = Fa6Brands.iconList["mintbit"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mix({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mix")) {
        body = Fa6Brands.iconList["mix"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mixcloud({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mixcloud")) {
        body = Fa6Brands.iconList["mixcloud"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mixer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mixer")) {
        body = Fa6Brands.iconList["mixer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mizuni({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("mizuni")) {
        body = Fa6Brands.iconList["mizuni"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget modx({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("modx")) {
        body = Fa6Brands.iconList["modx"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget monero({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("monero")) {
        body = Fa6Brands.iconList["monero"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget napster({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("napster")) {
        body = Fa6Brands.iconList["napster"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget neos({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("neos")) {
        body = Fa6Brands.iconList["neos"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget nfcDirectional({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("nfc-directional")) {
        body = Fa6Brands.iconList["nfc-directional"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget nfcSymbol({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("nfc-symbol")) {
        body = Fa6Brands.iconList["nfc-symbol"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget nimblr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("nimblr")) {
        body = Fa6Brands.iconList["nimblr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget node({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("node")) {
        body = Fa6Brands.iconList["node"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget nodeJs({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("node-js")) {
        body = Fa6Brands.iconList["node-js"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget npm({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("npm")) {
        body = Fa6Brands.iconList["npm"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ns8({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ns8")) {
        body = Fa6Brands.iconList["ns8"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget nutritionix({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 400 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("nutritionix")) {
        body = Fa6Brands.iconList["nutritionix"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget octopusDeploy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("octopus-deploy")) {
        body = Fa6Brands.iconList["octopus-deploy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget odnoklassniki({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("odnoklassniki")) {
        body = Fa6Brands.iconList["odnoklassniki"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget odysee({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("odysee")) {
        body = Fa6Brands.iconList["odysee"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget oldRepublic({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("old-republic")) {
        body = Fa6Brands.iconList["old-republic"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget opencart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("opencart")) {
        body = Fa6Brands.iconList["opencart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget openid({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("openid")) {
        body = Fa6Brands.iconList["openid"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget opensuse({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("opensuse")) {
        body = Fa6Brands.iconList["opensuse"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget opera({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("opera")) {
        body = Fa6Brands.iconList["opera"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget optinMonster({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("optin-monster")) {
        body = Fa6Brands.iconList["optin-monster"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget orcid({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("orcid")) {
        body = Fa6Brands.iconList["orcid"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget osi({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("osi")) {
        body = Fa6Brands.iconList["osi"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget padlet({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("padlet")) {
        body = Fa6Brands.iconList["padlet"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget page4({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("page4")) {
        body = Fa6Brands.iconList["page4"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pagelines({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pagelines")) {
        body = Fa6Brands.iconList["pagelines"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget palfed({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("palfed")) {
        body = Fa6Brands.iconList["palfed"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget patreon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("patreon")) {
        body = Fa6Brands.iconList["patreon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget paypal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("paypal")) {
        body = Fa6Brands.iconList["paypal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget perbyte({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("perbyte")) {
        body = Fa6Brands.iconList["perbyte"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget periscope({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("periscope")) {
        body = Fa6Brands.iconList["periscope"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget phabricator({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("phabricator")) {
        body = Fa6Brands.iconList["phabricator"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget phoenixFramework({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("phoenix-framework")) {
        body = Fa6Brands.iconList["phoenix-framework"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget phoenixSquadron({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("phoenix-squadron")) {
        body = Fa6Brands.iconList["phoenix-squadron"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget php({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("php")) {
        body = Fa6Brands.iconList["php"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget piedPiper({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 480 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pied-piper")) {
        body = Fa6Brands.iconList["pied-piper"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget piedPiperAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pied-piper-alt")) {
        body = Fa6Brands.iconList["pied-piper-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget piedPiperHat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pied-piper-hat")) {
        body = Fa6Brands.iconList["pied-piper-hat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget piedPiperPp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pied-piper-pp")) {
        body = Fa6Brands.iconList["pied-piper-pp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pinterest({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pinterest")) {
        body = Fa6Brands.iconList["pinterest"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pinterestP({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pinterest-p")) {
        body = Fa6Brands.iconList["pinterest-p"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pix({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pix")) {
        body = Fa6Brands.iconList["pix"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pixiv({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pixiv")) {
        body = Fa6Brands.iconList["pixiv"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget playstation({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("playstation")) {
        body = Fa6Brands.iconList["playstation"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget productHunt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("product-hunt")) {
        body = Fa6Brands.iconList["product-hunt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pushed({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 432 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("pushed")) {
        body = Fa6Brands.iconList["pushed"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget python({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("python")) {
        body = Fa6Brands.iconList["python"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget qq({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("qq")) {
        body = Fa6Brands.iconList["qq"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget quinscape({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("quinscape")) {
        body = Fa6Brands.iconList["quinscape"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget quora({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("quora")) {
        body = Fa6Brands.iconList["quora"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rProject({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 581 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("r-project")) {
        body = Fa6Brands.iconList["r-project"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget raspberryPi({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 407 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("raspberry-pi")) {
        body = Fa6Brands.iconList["raspberry-pi"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ravelry({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ravelry")) {
        body = Fa6Brands.iconList["ravelry"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget react({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("react")) {
        body = Fa6Brands.iconList["react"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget reacteurope({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("reacteurope")) {
        body = Fa6Brands.iconList["reacteurope"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget readme({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("readme")) {
        body = Fa6Brands.iconList["readme"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rebel({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("rebel")) {
        body = Fa6Brands.iconList["rebel"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget redRiver({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("red-river")) {
        body = Fa6Brands.iconList["red-river"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget reddit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("reddit")) {
        body = Fa6Brands.iconList["reddit"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget redditAlien({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("reddit-alien")) {
        body = Fa6Brands.iconList["reddit-alien"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget redhat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("redhat")) {
        body = Fa6Brands.iconList["redhat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget renren({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("renren")) {
        body = Fa6Brands.iconList["renren"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget replyd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("replyd")) {
        body = Fa6Brands.iconList["replyd"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget researchgate({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("researchgate")) {
        body = Fa6Brands.iconList["researchgate"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget resolving({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("resolving")) {
        body = Fa6Brands.iconList["resolving"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rev({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("rev")) {
        body = Fa6Brands.iconList["rev"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rocketchat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("rocketchat")) {
        body = Fa6Brands.iconList["rocketchat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget rockrms({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("rockrms")) {
        body = Fa6Brands.iconList["rockrms"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget rust({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("rust")) {
        body = Fa6Brands.iconList["rust"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget safari({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("safari")) {
        body = Fa6Brands.iconList["safari"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget salesforce({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("salesforce")) {
        body = Fa6Brands.iconList["salesforce"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sass({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("sass")) {
        body = Fa6Brands.iconList["sass"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget schlix({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("schlix")) {
        body = Fa6Brands.iconList["schlix"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget screenpal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("screenpal")) {
        body = Fa6Brands.iconList["screenpal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget scribd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("scribd")) {
        body = Fa6Brands.iconList["scribd"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget searchengin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 460 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("searchengin")) {
        body = Fa6Brands.iconList["searchengin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sellcast({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("sellcast")) {
        body = Fa6Brands.iconList["sellcast"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sellsy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("sellsy")) {
        body = Fa6Brands.iconList["sellsy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget servicestack({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("servicestack")) {
        body = Fa6Brands.iconList["servicestack"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shirtsinbulk({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("shirtsinbulk")) {
        body = Fa6Brands.iconList["shirtsinbulk"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget shoelace({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("shoelace")) {
        body = Fa6Brands.iconList["shoelace"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shopify({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("shopify")) {
        body = Fa6Brands.iconList["shopify"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget shopware({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("shopware")) {
        body = Fa6Brands.iconList["shopware"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget signalMessenger({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("signal-messenger")) {
        body = Fa6Brands.iconList["signal-messenger"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget simplybuilt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("simplybuilt")) {
        body = Fa6Brands.iconList["simplybuilt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sistrix({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("sistrix")) {
        body = Fa6Brands.iconList["sistrix"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sith({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("sith")) {
        body = Fa6Brands.iconList["sith"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sitrox({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("sitrox")) {
        body = Fa6Brands.iconList["sitrox"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sketch({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("sketch")) {
        body = Fa6Brands.iconList["sketch"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget skyatlas({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("skyatlas")) {
        body = Fa6Brands.iconList["skyatlas"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget skype({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("skype")) {
        body = Fa6Brands.iconList["skype"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget slack({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("slack")) {
        body = Fa6Brands.iconList["slack"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget slideshare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("slideshare")) {
        body = Fa6Brands.iconList["slideshare"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget snapchat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("snapchat")) {
        body = Fa6Brands.iconList["snapchat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget soundcloud({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("soundcloud")) {
        body = Fa6Brands.iconList["soundcloud"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget sourcetree({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("sourcetree")) {
        body = Fa6Brands.iconList["sourcetree"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget spaceAwesome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("space-awesome")) {
        body = Fa6Brands.iconList["space-awesome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget speakap({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("speakap")) {
        body = Fa6Brands.iconList["speakap"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget speakerDeck({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("speaker-deck")) {
        body = Fa6Brands.iconList["speaker-deck"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget spotify({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("spotify")) {
        body = Fa6Brands.iconList["spotify"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareBehance({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-behance")) {
        body = Fa6Brands.iconList["square-behance"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareBluesky({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-bluesky")) {
        body = Fa6Brands.iconList["square-bluesky"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareDribbble({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-dribbble")) {
        body = Fa6Brands.iconList["square-dribbble"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareFacebook({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-facebook")) {
        body = Fa6Brands.iconList["square-facebook"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareFontAwesome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-font-awesome")) {
        body = Fa6Brands.iconList["square-font-awesome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareFontAwesomeStroke({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-font-awesome-stroke")) {
        body = Fa6Brands.iconList["square-font-awesome-stroke"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareGit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-git")) {
        body = Fa6Brands.iconList["square-git"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareGithub({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-github")) {
        body = Fa6Brands.iconList["square-github"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareGitlab({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-gitlab")) {
        body = Fa6Brands.iconList["square-gitlab"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareGooglePlus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-google-plus")) {
        body = Fa6Brands.iconList["square-google-plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareHackerNews({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-hacker-news")) {
        body = Fa6Brands.iconList["square-hacker-news"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareInstagram({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-instagram")) {
        body = Fa6Brands.iconList["square-instagram"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareJs({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-js")) {
        body = Fa6Brands.iconList["square-js"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareLastfm({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-lastfm")) {
        body = Fa6Brands.iconList["square-lastfm"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareLetterboxd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-letterboxd")) {
        body = Fa6Brands.iconList["square-letterboxd"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareOdnoklassniki({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-odnoklassniki")) {
        body = Fa6Brands.iconList["square-odnoklassniki"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squarePiedPiper({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-pied-piper")) {
        body = Fa6Brands.iconList["square-pied-piper"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squarePinterest({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-pinterest")) {
        body = Fa6Brands.iconList["square-pinterest"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareReddit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-reddit")) {
        body = Fa6Brands.iconList["square-reddit"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareSnapchat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-snapchat")) {
        body = Fa6Brands.iconList["square-snapchat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareSteam({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-steam")) {
        body = Fa6Brands.iconList["square-steam"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareThreads({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-threads")) {
        body = Fa6Brands.iconList["square-threads"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareTumblr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-tumblr")) {
        body = Fa6Brands.iconList["square-tumblr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareTwitter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-twitter")) {
        body = Fa6Brands.iconList["square-twitter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareUpwork({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-upwork")) {
        body = Fa6Brands.iconList["square-upwork"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareViadeo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-viadeo")) {
        body = Fa6Brands.iconList["square-viadeo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareVimeo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-vimeo")) {
        body = Fa6Brands.iconList["square-vimeo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareWebAwesome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-web-awesome")) {
        body = Fa6Brands.iconList["square-web-awesome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareWebAwesomeStroke({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-web-awesome-stroke")) {
        body = Fa6Brands.iconList["square-web-awesome-stroke"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareWhatsapp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-whatsapp")) {
        body = Fa6Brands.iconList["square-whatsapp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareXTwitter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-x-twitter")) {
        body = Fa6Brands.iconList["square-x-twitter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareXing({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-xing")) {
        body = Fa6Brands.iconList["square-xing"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget squareYoutube({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("square-youtube")) {
        body = Fa6Brands.iconList["square-youtube"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget squarespace({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("squarespace")) {
        body = Fa6Brands.iconList["squarespace"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stackExchange({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("stack-exchange")) {
        body = Fa6Brands.iconList["stack-exchange"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stackOverflow({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("stack-overflow")) {
        body = Fa6Brands.iconList["stack-overflow"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stackpath({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("stackpath")) {
        body = Fa6Brands.iconList["stackpath"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget staylinked({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 440 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("staylinked")) {
        body = Fa6Brands.iconList["staylinked"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget steam({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("steam")) {
        body = Fa6Brands.iconList["steam"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget steamSymbol({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("steam-symbol")) {
        body = Fa6Brands.iconList["steam-symbol"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stickerMule({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("sticker-mule")) {
        body = Fa6Brands.iconList["sticker-mule"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget strava({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("strava")) {
        body = Fa6Brands.iconList["strava"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stripe({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("stripe")) {
        body = Fa6Brands.iconList["stripe"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stripeS({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("stripe-s")) {
        body = Fa6Brands.iconList["stripe-s"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget stubber({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("stubber")) {
        body = Fa6Brands.iconList["stubber"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget studiovinari({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("studiovinari")) {
        body = Fa6Brands.iconList["studiovinari"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stumbleupon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("stumbleupon")) {
        body = Fa6Brands.iconList["stumbleupon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stumbleuponCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("stumbleupon-circle")) {
        body = Fa6Brands.iconList["stumbleupon-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget superpowers({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("superpowers")) {
        body = Fa6Brands.iconList["superpowers"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget supple({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("supple")) {
        body = Fa6Brands.iconList["supple"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget suse({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("suse")) {
        body = Fa6Brands.iconList["suse"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget swift({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("swift")) {
        body = Fa6Brands.iconList["swift"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget symfony({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("symfony")) {
        body = Fa6Brands.iconList["symfony"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget teamspeak({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("teamspeak")) {
        body = Fa6Brands.iconList["teamspeak"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget telegram({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("telegram")) {
        body = Fa6Brands.iconList["telegram"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tencentWeibo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("tencent-weibo")) {
        body = Fa6Brands.iconList["tencent-weibo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget theRedYeti({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("the-red-yeti")) {
        body = Fa6Brands.iconList["the-red-yeti"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget themeco({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("themeco")) {
        body = Fa6Brands.iconList["themeco"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget themeisle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("themeisle")) {
        body = Fa6Brands.iconList["themeisle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget thinkPeaks({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("think-peaks")) {
        body = Fa6Brands.iconList["think-peaks"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget threads({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("threads")) {
        body = Fa6Brands.iconList["threads"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tiktok({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("tiktok")) {
        body = Fa6Brands.iconList["tiktok"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tradeFederation({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("trade-federation")) {
        body = Fa6Brands.iconList["trade-federation"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget trello({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("trello")) {
        body = Fa6Brands.iconList["trello"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tumblr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("tumblr")) {
        body = Fa6Brands.iconList["tumblr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget twitch({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("twitch")) {
        body = Fa6Brands.iconList["twitch"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget twitter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("twitter")) {
        body = Fa6Brands.iconList["twitter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget typo3({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("typo3")) {
        body = Fa6Brands.iconList["typo3"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget uber({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("uber")) {
        body = Fa6Brands.iconList["uber"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ubuntu({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ubuntu")) {
        body = Fa6Brands.iconList["ubuntu"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget uikit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("uikit")) {
        body = Fa6Brands.iconList["uikit"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget umbraco({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 510 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("umbraco")) {
        body = Fa6Brands.iconList["umbraco"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget uncharted({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("uncharted")) {
        body = Fa6Brands.iconList["uncharted"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget uniregistry({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("uniregistry")) {
        body = Fa6Brands.iconList["uniregistry"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget unity({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("unity")) {
        body = Fa6Brands.iconList["unity"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget unsplash({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("unsplash")) {
        body = Fa6Brands.iconList["unsplash"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget untappd({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("untappd")) {
        body = Fa6Brands.iconList["untappd"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ups({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ups")) {
        body = Fa6Brands.iconList["ups"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget upwork({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 641 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("upwork")) {
        body = Fa6Brands.iconList["upwork"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget usb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("usb")) {
        body = Fa6Brands.iconList["usb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget usps({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("usps")) {
        body = Fa6Brands.iconList["usps"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget ussunnah({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 482 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("ussunnah")) {
        body = Fa6Brands.iconList["ussunnah"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget vaadin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("vaadin")) {
        body = Fa6Brands.iconList["vaadin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget viacoin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("viacoin")) {
        body = Fa6Brands.iconList["viacoin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget viadeo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("viadeo")) {
        body = Fa6Brands.iconList["viadeo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget viber({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("viber")) {
        body = Fa6Brands.iconList["viber"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget vimeo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("vimeo")) {
        body = Fa6Brands.iconList["vimeo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget vimeoV({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("vimeo-v")) {
        body = Fa6Brands.iconList["vimeo-v"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget vine({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("vine")) {
        body = Fa6Brands.iconList["vine"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget vk({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("vk")) {
        body = Fa6Brands.iconList["vk"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget vnv({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("vnv")) {
        body = Fa6Brands.iconList["vnv"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget vuejs({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("vuejs")) {
        body = Fa6Brands.iconList["vuejs"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget watchmanMonitoring({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("watchman-monitoring")) {
        body = Fa6Brands.iconList["watchman-monitoring"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget waze({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("waze")) {
        body = Fa6Brands.iconList["waze"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget webAwesome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("web-awesome")) {
        body = Fa6Brands.iconList["web-awesome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget webflow({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("webflow")) {
        body = Fa6Brands.iconList["webflow"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget weebly({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("weebly")) {
        body = Fa6Brands.iconList["weebly"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget weibo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("weibo")) {
        body = Fa6Brands.iconList["weibo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget weixin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("weixin")) {
        body = Fa6Brands.iconList["weixin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget whatsapp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("whatsapp")) {
        body = Fa6Brands.iconList["whatsapp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget whmcs({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("whmcs")) {
        body = Fa6Brands.iconList["whmcs"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wikipediaW({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wikipedia-w")) {
        body = Fa6Brands.iconList["wikipedia-w"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget windows({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("windows")) {
        body = Fa6Brands.iconList["windows"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wirsindhandwerk({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wirsindhandwerk")) {
        body = Fa6Brands.iconList["wirsindhandwerk"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wix({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wix")) {
        body = Fa6Brands.iconList["wix"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wizardsOfTheCoast({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wizards-of-the-coast")) {
        body = Fa6Brands.iconList["wizards-of-the-coast"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wodu({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wodu")) {
        body = Fa6Brands.iconList["wodu"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wolfPackBattalion({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wolf-pack-battalion")) {
        body = Fa6Brands.iconList["wolf-pack-battalion"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wordpress({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wordpress")) {
        body = Fa6Brands.iconList["wordpress"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wordpressSimple({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wordpress-simple")) {
        body = Fa6Brands.iconList["wordpress-simple"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wpbeginner({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wpbeginner")) {
        body = Fa6Brands.iconList["wpbeginner"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wpexplorer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wpexplorer")) {
        body = Fa6Brands.iconList["wpexplorer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wpforms({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wpforms")) {
        body = Fa6Brands.iconList["wpforms"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget wpressr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("wpressr")) {
        body = Fa6Brands.iconList["wpressr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget xTwitter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("x-twitter")) {
        body = Fa6Brands.iconList["x-twitter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget xbox({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("xbox")) {
        body = Fa6Brands.iconList["xbox"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget xing({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("xing")) {
        body = Fa6Brands.iconList["xing"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget yCombinator({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("y-combinator")) {
        body = Fa6Brands.iconList["y-combinator"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget yahoo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("yahoo")) {
        body = Fa6Brands.iconList["yahoo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget yammer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 512 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("yammer")) {
        body = Fa6Brands.iconList["yammer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget yandex({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 256 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("yandex")) {
        body = Fa6Brands.iconList["yandex"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget yandexInternational({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 320 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("yandex-international")) {
        body = Fa6Brands.iconList["yandex-international"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget yarn({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 496 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("yarn")) {
        body = Fa6Brands.iconList["yarn"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget yelp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 384 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("yelp")) {
        body = Fa6Brands.iconList["yelp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget yoast({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("yoast")) {
        body = Fa6Brands.iconList["yoast"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget youtube({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 576 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("youtube")) {
        body = Fa6Brands.iconList["youtube"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget zhihu({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 640 24" height="1em" version="1.1">';
    var body = "";
    if(Fa6Brands.iconList.containsKey("zhihu")) {
        body = Fa6Brands.iconList["zhihu"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Map<String,Widget Function({double? width,double? height,Color? color})> names  =   {
    ...
    "napster":napster,
    "neos":neos,
    "nfc-directional":nfcDirectional,
    "nfc-symbol":nfcSymbol,
    "nimblr":nimblr,
    "node":node,
    "node-js":nodeJs,
    "npm":npm,
    ...
    "shopify":shopify,
    "shopware":shopware,
    "signal-messenger":signalMessenger,
    ...
    "space-awesome":spaceAwesome,
    "speakap":speakap,
    "speaker-deck":speakerDeck,
    "spotify":spotify,
    "square-behance":squareBehance,
    "square-bluesky":squareBluesky,
    "square-dribbble":squareDribbble,
    "square-facebook":squareFacebook,
    "square-font-awesome":squareFontAwesome,
    "square-font-awesome-stroke":squareFontAwesomeStroke,
    "square-git":squareGit,
    "square-github":squareGithub,
    "square-gitlab":squareGitlab,
    "square-google-plus":squareGooglePlus,
    "square-hacker-news":squareHackerNews,
    "square-instagram":squareInstagram,
    "square-js":squareJs,
    "square-lastfm":squareLastfm,
    "square-letterboxd":squareLetterboxd,
    "square-odnoklassniki":squareOdnoklassniki,
    "square-pied-piper":squarePiedPiper,
    "square-pinterest":squarePinterest,
    "square-reddit":squareReddit,
    "square-snapchat":squareSnapchat,
    "square-steam":squareSteam,
    "square-threads":squareThreads,
    "square-tumblr":squareTumblr,
    "square-twitter":squareTwitter,
    "square-upwork":squareUpwork,
    "square-viadeo":squareViadeo,
    "square-vimeo":squareVimeo,
    "square-web-awesome":squareWebAwesome,
    "square-web-awesome-stroke":squareWebAwesomeStroke,
    "square-whatsapp":squareWhatsapp,
    "square-x-twitter":squareXTwitter,
    "square-xing":squareXing,
    "square-youtube":squareYoutube,
...
static Map<String,String> iconList  =   {
    ...
    "linkedin-in":'<path fill="currentColor" d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3M447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2c-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3c94 0 111.28 61.9 111.28 142.3V448z"/>',
    "linode":'<path fill="currentColor" d="m366.036 186.867l-59.5 36.871l-.838 36.871l-29.329-19.273l-39.384 24.3c2.238 55.211 2.483 59.271 2.51 59.5l-97.2 65.359l-15.081-104.747l108.1-62.01l-40.224-25.977l-75.417 38.547l-20.95-143.293l129.048-49.441L136.432 0L10.737 39.385L38.39 174.3l41.9 32.681l-31.845 15.081l20.949 101.395l29.329 27.653l-20.949 12.569l16.76 78.769L160.733 512c-10.8-74.842-11.658-78.641-11.725-78.773l77.925-55.3c16.759-12.57 15.083-10.894 15.083-10.894l.838 24.3l33.519 28.491l-.838-77.093l46.927-33.519l26.815-18.435l-2.514 36.033l25.139 17.6l6.7-74.579l58.657-43.575Z"/>',
    ...
    "twitter":'<path fill="currentColor" d="M459.37 151.716c.325 4.548.325 9.097.325 13.645c0 138.72-105.583 298.558-298.558 298.558c-59.452 0-114.68-17.219-161.137-47.106c8.447.974 16.568 1.299 25.34 1.299c49.055 0 94.213-16.568 130.274-44.832c-46.132-.975-84.792-31.188-98.112-72.772c6.498.974 12.995 1.624 19.818 1.624c9.421 0 18.843-1.3 27.614-3.573c-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319c-28.264-18.843-46.781-51.005-46.781-87.391c0-19.492 5.197-37.36 14.294-52.954c51.655 63.675 129.3 105.258 216.365 109.807c-1.624-7.797-2.599-15.918-2.599-24.04c0-57.828 46.782-104.934 104.934-104.934c30.213 0 57.502 12.67 76.67 33.137c23.715-4.548 46.456-13.32 66.599-25.34c-7.798 24.366-24.366 44.833-46.132 57.827c21.117-2.273 41.584-8.122 60.426-16.243c-14.292 20.791-32.161 39.308-52.628 54.253"/>',
    "typo3":'<path fill="currentColor" d="M178.7 78.4c0-24.7 5.4-32.4 13.9-39.4c-69.5 8.5-149.3 34-176.3 66.4c-5.4 7.7-9.3 20.8-9.3 37.1C7 246 113.8 480 191.1 480c36.3 0 97.3-59.5 146.7-139c-7 2.3-11.6 2.3-18.5 2.3c-57.2 0-140.6-198.5-140.6-264.9M301.5 32c-30.1 0-41.7 5.4-41.7 36.3c0 66.4 53.8 198.5 101.7 198.5c26.3 0 78.8-99.7 78.8-182.3c0-40.9-67-52.5-138.8-52.5"/>',
    "uber":'<path fill="currentColor" d="M414.1 32H33.9C15.2 32 0 47.2 0 65.9V446c0 18.8 15.2 34 33.9 34H414c18.7 0 33.9-15.2 33.9-33.9V65.9C448 47.2 432.8 32 414.1 32M237.6 391.1C163 398.6 96.4 344.2 88.9 269.6h94.4V290c0 3.7 3 6.8 6.8 6.8H258c3.7 0 6.8-3 6.8-6.8v-67.9c0-3.7-3-6.8-6.8-6.8h-67.9c-3.7 0-6.8 3-6.8 6.8v20.4H88.9c7-69.4 65.4-122.2 135.1-122.2s128.1 52.8 135.1 122.2c7.5 74.5-46.9 141.1-121.5 148.6"/>',
