...
// bxl 2.1.4 icon package is licensed under CC-BY-4.0 https://creativecommons.org/licenses/by/4.0/, {Atisa https://github.com/atisawd/boxicons}
// 
...
static Widget getIcon(String name,{double? width,double? height,Color? color}) {
    return Bxl.names[name]!(width:width,height:height,color:color);
}
...
static Widget i500Px({double? width,double? height,Color? color}) { 
    ...
    var body = "";
    if(Bxl.iconList.containsKey("500px")) {
        body = Bxl.iconList["500px"]!;
    }
...
static Widget i99Designs({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("99designs")) {
        body = Bxl.iconList["99designs"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget adobe({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("adobe")) {
        body = Bxl.iconList["adobe"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget airbnb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("airbnb")) {
        body = Bxl.iconList["airbnb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget algolia({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("algolia")) {
        body = Bxl.iconList["algolia"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget amazon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("amazon")) {
        body = Bxl.iconList["amazon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget android({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("android")) {
        body = Bxl.iconList["android"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget angular({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("angular")) {
        body = Bxl.iconList["angular"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget apple({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("apple")) {
        body = Bxl.iconList["apple"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget audible({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("audible")) {
        body = Bxl.iconList["audible"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget aws({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("aws")) {
        body = Bxl.iconList["aws"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget baidu({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("baidu")) {
        body = Bxl.iconList["baidu"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget behance({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("behance")) {
        body = Bxl.iconList["behance"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bing({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("bing")) {
        body = Bxl.iconList["bing"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bitcoin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("bitcoin")) {
        body = Bxl.iconList["bitcoin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget blender({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("blender")) {
        body = Bxl.iconList["blender"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget blogger({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("blogger")) {
        body = Bxl.iconList["blogger"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget bootstrap({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("bootstrap")) {
        body = Bxl.iconList["bootstrap"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget cPlusPlus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("c-plus-plus")) {
        body = Bxl.iconList["c-plus-plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget chrome({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("chrome")) {
        body = Bxl.iconList["chrome"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget codepen({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("codepen")) {
        body = Bxl.iconList["codepen"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget creativeCommons({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("creative-commons")) {
        body = Bxl.iconList["creative-commons"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget css3({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("css3")) {
        body = Bxl.iconList["css3"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget dailymotion({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("dailymotion")) {
        body = Bxl.iconList["dailymotion"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget deezer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("deezer")) {
        body = Bxl.iconList["deezer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget devTo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("dev-to")) {
        body = Bxl.iconList["dev-to"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget deviantart({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("deviantart")) {
        body = Bxl.iconList["deviantart"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget digg({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("digg")) {
        body = Bxl.iconList["digg"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget digitalocean({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("digitalocean")) {
        body = Bxl.iconList["digitalocean"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget discord({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("discord")) {
        body = Bxl.iconList["discord"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget discordAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("discord-alt")) {
        body = Bxl.iconList["discord-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget discourse({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("discourse")) {
        body = Bxl.iconList["discourse"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget django({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("django")) {
        body = Bxl.iconList["django"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget docker({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("docker")) {
        body = Bxl.iconList["docker"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget dribbble({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("dribbble")) {
        body = Bxl.iconList["dribbble"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget dropbox({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("dropbox")) {
        body = Bxl.iconList["dropbox"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget drupal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("drupal")) {
        body = Bxl.iconList["drupal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget ebay({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("ebay")) {
        body = Bxl.iconList["ebay"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget edge({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("edge")) {
        body = Bxl.iconList["edge"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget etsy({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("etsy")) {
        body = Bxl.iconList["etsy"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget facebook({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("facebook")) {
        body = Bxl.iconList["facebook"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget facebookCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("facebook-circle")) {
        body = Bxl.iconList["facebook-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget facebookSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("facebook-square")) {
        body = Bxl.iconList["facebook-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget figma({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("figma")) {
        body = Bxl.iconList["figma"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget firebase({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("firebase")) {
        body = Bxl.iconList["firebase"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget firefox({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("firefox")) {
        body = Bxl.iconList["firefox"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget flask({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("flask")) {
        body = Bxl.iconList["flask"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget flickr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("flickr")) {
        body = Bxl.iconList["flickr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget flickrSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("flickr-square")) {
        body = Bxl.iconList["flickr-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget flutter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("flutter")) {
        body = Bxl.iconList["flutter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget foursquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("foursquare")) {
        body = Bxl.iconList["foursquare"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget git({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("git")) {
        body = Bxl.iconList["git"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget github({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("github")) {
        body = Bxl.iconList["github"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget gitlab({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("gitlab")) {
        body = Bxl.iconList["gitlab"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget gmail({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("gmail")) {
        body = Bxl.iconList["gmail"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget goLang({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("go-lang")) {
        body = Bxl.iconList["go-lang"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget google({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("google")) {
        body = Bxl.iconList["google"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget googleCloud({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("google-cloud")) {
        body = Bxl.iconList["google-cloud"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget googlePlus({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("google-plus")) {
        body = Bxl.iconList["google-plus"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget googlePlusCircle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("google-plus-circle")) {
        body = Bxl.iconList["google-plus-circle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget graphql({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("graphql")) {
        body = Bxl.iconList["graphql"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget heroku({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("heroku")) {
        body = Bxl.iconList["heroku"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget html5({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("html5")) {
        body = Bxl.iconList["html5"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget imdb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("imdb")) {
        body = Bxl.iconList["imdb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget instagram({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("instagram")) {
        body = Bxl.iconList["instagram"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget instagramAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("instagram-alt")) {
        body = Bxl.iconList["instagram-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget internetExplorer({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("internet-explorer")) {
        body = Bxl.iconList["internet-explorer"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget invision({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("invision")) {
        body = Bxl.iconList["invision"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget java({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("java")) {
        body = Bxl.iconList["java"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget javascript({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("javascript")) {
        body = Bxl.iconList["javascript"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget joomla({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("joomla")) {
        body = Bxl.iconList["joomla"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget jquery({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("jquery")) {
        body = Bxl.iconList["jquery"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget jsfiddle({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("jsfiddle")) {
        body = Bxl.iconList["jsfiddle"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget kickstarter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("kickstarter")) {
        body = Bxl.iconList["kickstarter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget kubernetes({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("kubernetes")) {
        body = Bxl.iconList["kubernetes"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget less({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("less")) {
        body = Bxl.iconList["less"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget linkedin({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("linkedin")) {
        body = Bxl.iconList["linkedin"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget linkedinSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("linkedin-square")) {
        body = Bxl.iconList["linkedin-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget magento({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("magento")) {
        body = Bxl.iconList["magento"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mailchimp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("mailchimp")) {
        body = Bxl.iconList["mailchimp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget markdown({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("markdown")) {
        body = Bxl.iconList["markdown"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mastercard({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("mastercard")) {
        body = Bxl.iconList["mastercard"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mastodon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("mastodon")) {
        body = Bxl.iconList["mastodon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget medium({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("medium")) {
        body = Bxl.iconList["medium"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mediumOld({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("medium-old")) {
        body = Bxl.iconList["medium-old"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget mediumSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("medium-square")) {
        body = Bxl.iconList["medium-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget messenger({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("messenger")) {
        body = Bxl.iconList["messenger"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget meta({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("meta")) {
        body = Bxl.iconList["meta"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget microsoft({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("microsoft")) {
        body = Bxl.iconList["microsoft"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget microsoftTeams({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("microsoft-teams")) {
        body = Bxl.iconList["microsoft-teams"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget mongodb({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("mongodb")) {
        body = Bxl.iconList["mongodb"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget netlify({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("netlify")) {
        body = Bxl.iconList["netlify"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget nodejs({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("nodejs")) {
        body = Bxl.iconList["nodejs"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget okRu({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("ok-ru")) {
        body = Bxl.iconList["ok-ru"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget opera({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("opera")) {
        body = Bxl.iconList["opera"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget patreon({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("patreon")) {
        body = Bxl.iconList["patreon"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget paypal({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("paypal")) {
        body = Bxl.iconList["paypal"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget periscope({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("periscope")) {
        body = Bxl.iconList["periscope"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget php({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("php")) {
        body = Bxl.iconList["php"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pinterest({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("pinterest")) {
        body = Bxl.iconList["pinterest"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget pinterestAlt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("pinterest-alt")) {
        body = Bxl.iconList["pinterest-alt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget playStore({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("play-store")) {
        body = Bxl.iconList["play-store"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget pocket({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("pocket")) {
        body = Bxl.iconList["pocket"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget postgresql({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("postgresql")) {
        body = Bxl.iconList["postgresql"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget productHunt({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("product-hunt")) {
        body = Bxl.iconList["product-hunt"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget python({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("python")) {
        body = Bxl.iconList["python"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget quora({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("quora")) {
        body = Bxl.iconList["quora"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget react({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("react")) {
        body = Bxl.iconList["react"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget redbubble({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("redbubble")) {
        body = Bxl.iconList["redbubble"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget reddit({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("reddit")) {
        body = Bxl.iconList["reddit"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget redux({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("redux")) {
        body = Bxl.iconList["redux"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sass({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("sass")) {
        body = Bxl.iconList["sass"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget shopify({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("shopify")) {
        body = Bxl.iconList["shopify"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget sketch({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("sketch")) {
        body = Bxl.iconList["sketch"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget skype({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("skype")) {
        body = Bxl.iconList["skype"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget slack({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("slack")) {
        body = Bxl.iconList["slack"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget slackOld({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("slack-old")) {
        body = Bxl.iconList["slack-old"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget snapchat({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("snapchat")) {
        body = Bxl.iconList["snapchat"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget soundcloud({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("soundcloud")) {
        body = Bxl.iconList["soundcloud"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget spotify({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("spotify")) {
        body = Bxl.iconList["spotify"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget springBoot({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("spring-boot")) {
        body = Bxl.iconList["spring-boot"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget squarespace({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("squarespace")) {
        body = Bxl.iconList["squarespace"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stackOverflow({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("stack-overflow")) {
        body = Bxl.iconList["stack-overflow"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget steam({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("steam")) {
        body = Bxl.iconList["steam"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget stripe({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("stripe")) {
        body = Bxl.iconList["stripe"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 

static Widget tailwindCss({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("tailwind-css")) {
        body = Bxl.iconList["tailwind-css"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget telegram({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("telegram")) {
        body = Bxl.iconList["telegram"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tiktok({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("tiktok")) {
        body = Bxl.iconList["tiktok"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget trello({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("trello")) {
        body = Bxl.iconList["trello"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tripAdvisor({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("trip-advisor")) {
        body = Bxl.iconList["trip-advisor"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tumblr({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("tumblr")) {
        body = Bxl.iconList["tumblr"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget tux({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("tux")) {
        body = Bxl.iconList["tux"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget twitch({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("twitch")) {
        body = Bxl.iconList["twitch"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget twitter({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("twitter")) {
        body = Bxl.iconList["twitter"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget typescript({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("typescript")) {
        body = Bxl.iconList["typescript"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget unity({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("unity")) {
        body = Bxl.iconList["unity"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget unsplash({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("unsplash")) {
        body = Bxl.iconList["unsplash"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget upwork({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("upwork")) {
        body = Bxl.iconList["upwork"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget venmo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("venmo")) {
        body = Bxl.iconList["venmo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget vimeo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("vimeo")) {
        body = Bxl.iconList["vimeo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget visa({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("visa")) {
        body = Bxl.iconList["visa"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget visualStudio({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("visual-studio")) {
        body = Bxl.iconList["visual-studio"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget vk({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("vk")) {
        body = Bxl.iconList["vk"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget vuejs({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("vuejs")) {
        body = Bxl.iconList["vuejs"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget whatsapp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("whatsapp")) {
        body = Bxl.iconList["whatsapp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget whatsappSquare({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("whatsapp-square")) {
        body = Bxl.iconList["whatsapp-square"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wikipedia({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("wikipedia")) {
        body = Bxl.iconList["wikipedia"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget windows({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("windows")) {
        body = Bxl.iconList["windows"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wix({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("wix")) {
        body = Bxl.iconList["wix"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget wordpress({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("wordpress")) {
        body = Bxl.iconList["wordpress"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget xing({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("xing")) {
        body = Bxl.iconList["xing"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget yahoo({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("yahoo")) {
        body = Bxl.iconList["yahoo"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget yelp({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("yelp")) {
        body = Bxl.iconList["yelp"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget youtube({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("youtube")) {
        body = Bxl.iconList["youtube"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
...
static Widget zoom({double? width,double? height,Color? color}) { 
       var svg_start = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" viewBox="0 0 24 24" height="1em" version="1.1">';
    var body = "";
    if(Bxl.iconList.containsKey("zoom")) {
        body = Bxl.iconList["zoom"]!;
    }
    return SvgPicture.string("${svg_start}${body}</svg>",width: width,height: height,colorFilter:color != null ? ColorFilter.mode(color!, BlendMode.srcIn) : null);
    } 
