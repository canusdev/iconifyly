// OOUI Copyright (c), OOUI Team(https://github.com/wikimedia/oojs-ui). All rights reserved.
// Use of this icons source code is governed by a
// MIT license that can be found in the https://github.com/wikimedia/oojs-ui/blob/master/LICENSE-MIT url.
...
import 'package:iconifyly/icons/ooui.icon.reflectable.dart';

@reflector
class Ooui extends IconifylyInterface {
  ...
  static Map<String, Map<String, dynamic>> names() {
    return {
      ...
      "bold-cyrl-te": {
        "body": "<path fill=\"currentColor\" d=\"M12 19H8V4H3V1h14v3h-5z\"/>"
      },
      "bold-cyrl-zhe": {
        "body":
      ...
      "bold-f": {
        "body": "<path fill=\"currentColor\" d=\"M9 19H5V1h10v3H9v5h5v3H9z\"/>"
      },
      "bold-g": {
        "body":
      ...
      "bold-l": {
        "body": "<path fill=\"currentColor\" d=\"M5 19V1h4v15h7v3z\"/>"
      },
      "bold-n": {
        "body":
      ...
      "flag-ltr": {
        "body": "<path fill=\"currentColor\" d=\"M17 6L3 1v18h2v-6.87z\"/>"
      },
      "flag-rtl": {
        "body": "<path fill=\"currentColor\" d=\"m3 6l14-5v18h-2v-6.87z\"/>"
      },
      "folder-placeholder-ltr": {
        "body":
            "<path fill=\"currentColor\" d=\"M8 2H2a2 2 0 0 0-2 2v2h12z\"/><rect width=\"20\" height=\"14\" y=\"4\" fill=\"currentColor\" rx=\"2\"/>"
      },
      "folder-placeholder-rtl": {
        "body":
      ...
      "link-external-ltr": {
        "body":
            "<path fill=\"currentColor\" d=\"M17 17H3V3h5V1H3a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5h-2z\"/><path fill=\"currentColor\" d=\"m11 1l3.29 3.29l-5.73 5.73l1.42 1.42l5.73-5.73L19 9V1z\"/>"
      },
      "link-external-rtl": {
        "body":
      ...
      "logo-wikiquote": {
        "body":
            "<path fill=\"currentColor\" d=\"M9.133 4.643a6.52 6.52 0 0 1 2.79 5.354a6.52 6.52 0 0 1-2.672 5.269l-.12.086l-.923-1.322a4.91 4.91 0 0 0 2.103-4.033c0-1.578-.748-3.03-1.988-3.95l-.114-.082z\"/><path fill=\"currentColor\" d=\"M5.347 13.275a3.347 3.347 0 1 0-.001-6.695a3.347 3.347 0 0 0 .001 6.695M13.874 0a13.08 13.08 0 0 1 4.627 9.997c0 3.86-1.678 7.448-4.538 9.92l-.096.083l-1.15-1.357a11.3 11.3 0 0 0 4.006-8.646c0-3.33-1.444-6.424-3.908-8.562l-.091-.079L13.873 0Z\"/><path fill=\"currentColor\" d=\"M11.453 2.386a9.71 9.71 0 0 1 3.668 7.611a9.71 9.71 0 0 1-3.576 7.537l-.09.073l-1.074-1.347A7.99 7.99 0 0 0 13.4 9.997a7.99 7.99 0 0 0-2.932-6.194l-.087-.07l1.073-1.347Z\"/>"
      },
      "logo-wikisource": {
        "body":
      ...
      "subtract": {"body": "<path fill=\"currentColor\" d=\"M4 9h12v2H4z\"/>"},
      "success": {
        "body":
      ...
      "text-summary-ltr": {
        "body": "<path fill=\"currentColor\" d=\"M1 7h18v2H1zm0 4h14v2H1z\"/>"
      },
      "text-summary-rtl": {
        "body": "<path fill=\"currentColor\" d=\"M1 7h18v2H1zm4 4h14v2H5z\"/>"
      },
      "trash": {
        "body":
      ...
      "up-triangle": {
        "body": "<path fill=\"currentColor\" d=\"m10 5l8 10H2z\"/>"
      },
      "upload": {
        "body":
