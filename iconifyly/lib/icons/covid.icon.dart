// Covid Icons Copyright (c), Streamline(https://github.com/webalys-hq/streamline-vectors). All rights reserved.
...
import 'package:iconifyly/icons/covid.icon.reflectable.dart';

@reflector
class Covid extends IconifylyInterface {
